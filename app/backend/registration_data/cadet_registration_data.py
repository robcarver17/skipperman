...
def get_dict_of_cadets_with_registration_data(
    ...
    return object_store.get(
        object_store.data_api.data_cadets_at_event.read_dict_of_cadets_with_registration_data_at_event,
        event_id=event.id,
    )
...
def get_registration_data_for_single_cadet_at_event(
    ...
    cadet_with_id_at_event = (
        object_store.data_api.data_cadets_at_event.get_existing_cadet_at_event(
            event_id=event.id, cadet_id=cadet.id
        )
    )
    return CadetRegistrationData.from_cadet_with_id_at_event(
        event=event, cadet_with_id_at_event=cadet_with_id_at_event
    )


def is_event_first_event_for_cadet(
    object_store: ObjectStore, event: Event, cadet: Cadet
):
...
def get_list_of_cadets_with_id_and_registration_data_at_event(
    ...
    return object_store.get(
        object_store.data_api.data_cadets_at_event.read, event_id=event.id
    )
...
def update_list_of_cadets_with_registration_data(
    ...
    interface.update(
        interface.object_store.data_api.data_cadets_at_event.write,
        event_id=event.id,
