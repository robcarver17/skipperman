...
MembershipStatus = enum.Enum(
    "MembershipStatus",
    ["Current", "None_Member", "Lapsed", "Unconfirmed", "UserUnconfirmed"],
)
...
)  ## ONLY USED BY SYSTEM, USER SHOULD NOT SEE
...
all_status_as_list_for_user_input = [
    none_member,
    current_member,
    lapsed_member,
