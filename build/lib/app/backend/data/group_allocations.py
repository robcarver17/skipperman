...
class GroupAllocationsData:
    ...
    def day_selector_for_cadet_id_and_group_at_event(
        ...
        list_of_cadet_ids_with_groups = self.get_list_of_cadet_ids_with_groups_at_event(
            event
        )
    ...
    def get_list_of_cadets_with_group_given_list_of_cadets_with_ids_and_groups(
        ...
        try:
            ...
            raise Exception(
                "Cadets in backend missing from master list of group_allocations"
            )
    ...
    def active_cadet_ids_with_groups_for_group_at_event(
        ...
        list_of_cadets_with_groups = self.get_list_of_cadet_ids_with_groups_at_event(
            event
        )
    ...
    def unallocated_cadets_at_event(self, event: Event) -> ListOfCadets:
        list_of_cadets_in_groups_at_event = (
            self.get_list_of_cadet_ids_with_groups_at_event(event)
        )
    ...
    def get_list_of_cadet_ids_with_groups_at_event_on_day(
        ...
        list_of_cadet_id_with_group = self.get_list_of_cadet_ids_with_groups_at_event(
            event=event
        )
    ...
    def get_list_of_cadet_ids_with_groups_at_event(
        self, event: Event
    ) -> ListOfCadetIdsWithGroups:
