...
def display_form_for_update_to_existing_row_of_event_data(
    ...
    status_change_field = get_status_change_field(
...
def any_important_difference_between_rows(
    ...
    dict_of_other_diffs = get_dict_of_dict_diffs(
        new_row_in_mapped_wa_event_with_status=new_row_in_mapped_wa_event_with_status,
        existing_row_in_master_event=existing_row_in_master_event,
    )
...
def get_form_fields_with_other_differences(
    new_row_in_mapped_wa_event_with_status: RowInMasterEvent,
    existing_row_in_master_event: RowInMasterEvent,
) -> ListOfLines:
    dict_of_dict_diffs = get_dict_of_dict_diffs(
        new_row_in_mapped_wa_event_with_status=new_row_in_mapped_wa_event_with_status,
        existing_row_in_master_event=existing_row_in_master_event,
    )
    ...
    for field in field_names:
        try:
            new_row_in_mapped_wa_event_with_status.data_in_row[
                field
            ] = interface.value_from_form(field)
        except:
