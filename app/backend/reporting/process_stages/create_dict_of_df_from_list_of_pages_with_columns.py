...
from app.backend.reporting.process_stages.strings_columns_groups import ListOfPagesWithColumns, PageWithColumns, Column, \
    GroupOfMarkedUpString


def convert_list_of_pages_with_columns_to_dict_of_df( list_of_pages_with_columns: ListOfPagesWithColumns) -> Dict[str, pd.DataFrame]:
    dict_of_df = {}
...
def convert_group_of_marked_str_into_df(group_of_marked_string: GroupOfMarkedUpString)-> pd.DataFrame:
    list_of_df = []
