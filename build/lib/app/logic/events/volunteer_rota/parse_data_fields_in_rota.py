...
def update_details_from_form_for_volunteer_at_event(interface: abstractInterface, volunteer_at_event: VolunteerAtEventWithId):
...
def update_details_for_days_from_form_for_volunteer_at_event(interface: abstractInterface, volunteer_at_event: VolunteerAtEventWithId):
...
def update_notes_for_volunteer_at_event_from_form(interface: abstractInterface, volunteer_at_event: VolunteerAtEventWithId):
    event = get_event_from_state(interface)
