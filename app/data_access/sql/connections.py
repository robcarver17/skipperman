...
class SqlDataListOfCadetVolunteerAssociations(
    ...
    def add_volunteer_connection_to_cadet(
    ...
    def get_list_of_cadets_associated_with_volunteer(
        ...
        return self.list_of_cadets.subset_from_list_of_ids_retaining_order(list_of_ids=raw_list)

    def get_list_of_cadet_ids_associated_with_volunteer(
            self, volunteer_id:str) -> List[str]:
        try:
            if self.table_does_not_exist(CADET_VOLUNTEER_CONNECTIONS_TABLE):
                return []
    ...
    def _add_row_without_commits_or_checks(self,cadet_volunteer_association: CadetVolunteerAssociationWithIds ):
