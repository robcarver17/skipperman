...
from app.objects.mapped_wa_event import RowInMappedWAEvent, DEPRECATE_RegistrationStatus, R_cancelled_status, R_active_paid_status, \
    R_deleted_status, R_manual_add_status
...
def get_status_button(current_status: DEPRECATE_RegistrationStatus, cadet_id: str)-> dropDownInput:
    if current_status in [R_cancelled_status, R_active_paid_status]:
        allowable_status = [R_cancelled_status, R_active_paid_status]
    elif current_status == R_deleted_status:
        allowable_status = [R_cancelled_status, R_active_paid_status, R_deleted_status]
    elif current_status == R_manual_add_status:
        allowable_status = [R_cancelled_status, R_manual_add_status]
    else:
