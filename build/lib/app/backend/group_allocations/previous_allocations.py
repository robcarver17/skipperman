...
def DEPRECATE_get_dict_of_allocations_for_events_and_list_of_cadets(list_of_events: list) -> Dict[Event, ListOfCadetIdsWithGroups]:
...
def get_dict_of_all_event_allocations_for_single_cadet(cadet: Cadet) -> Dict[Event, Group]:
    ...
    previous_allocations_as_dict = DEPRECATE_get_dict_of_allocations_for_events_and_list_of_cadets(list_of_events)
