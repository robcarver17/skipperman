**To get to the clone mapping page: Main menu/Events/Select event/Import registration data/Import from WA/Check of modify WA mapping/Clone the mapping for an existing event**
