...
class ListOfRawAttendanceItemsForSpecificCadet(GenericListOfObjects):
    ...
    def subset_for_cadet_at_event_on_day(self, event_id: str, day: Day):
        subset = get_subset_of_list_that_matches_multiple_attr(self,dict_of_attributes=
                                                      {
                                                          'day':day,
                                                          'event_id': event_id
                                                      })
    ...
    def add_new_attendance_for_cadet_on_day(self, event_id: str, datetime_marked: datetime.datetime, day: Day, attendance: Attendance):
        self.append(
            RawAttendanceItem(
                event_id=event_id,
                day=day,
