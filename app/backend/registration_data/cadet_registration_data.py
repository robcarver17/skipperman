...
def get_cadet_at_event(
    ...
    cadets_at_event = get_list_of_cadets_with_id_and_registration_data_at_event(object_store=object_store, event=event)
...
def add_new_cadet_to_event_from_row_in_registration_data(
    ...
    add_new_cadet_to_event(object_store=object_store,
                           event=event,
...
def get_list_of_active_cadets_at_event(    object_store: ObjectStore, event: Event
) -> ListOfCadets:
    dict_of_cadets_with_registration_data = get_dict_of_cadets_with_registration_data(object_store=object_store, event=event)
...
def is_cadet_already_at_event(
    ...
    list_of_cadets_with_id_and_registration_data_at_event = get_list_of_cadets_with_id_and_registration_data_at_event(
        object_store=object_store,
        event=event
    )
    return list_of_cadets_with_id_and_registration_data_at_event.is_cadet_id_in_event(cadet_id=cadet.id)
