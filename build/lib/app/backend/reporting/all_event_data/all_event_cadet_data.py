...
def get_df_for_cadets_event_data_dump(object_store: ObjectStore, event: Event):
    ...
    list_of_cadet_DOB = list_of_cadets.list_of_DOB()
    list_of_Cadet_ages = list_of_cadets.list_of_ages()
    list_of_colour_for_cadet = [
        colour_group_for_cadet(
    ...
    df = pd.DataFrame(
        {
            ...
            "DOB": list_of_cadet_DOB,
            "Age": list_of_Cadet_ages,
            "Colour group": list_of_colour_for_cadet,
