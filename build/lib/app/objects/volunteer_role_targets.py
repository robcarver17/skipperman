...
class ListOfTargetForRoleWithIdAtEvent(GenericListOfObjects):
    ...
    def set_target_for_role(self, role_id: str, target: int):
        matching_item = self._get_target_object_for_role_at_event(
            role_id, default=missing_data
        )
    ...
    def _get_target_object_for_role_at_event(
        self, role_id: str, default=arg_not_passed
    ):
        return get_unique_object_with_attr_in_list(
            some_list=self, attr_name="role_id", attr_value=role_id, default=default
        )
