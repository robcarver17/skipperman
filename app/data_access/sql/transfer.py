...
sql_persistent_groups = SqlDataListOfGroupNamesForEventsAndCadetPersistentVersion(db_connection, object_store)
...
sql_cadets_and_dinghies_at_event = SqlDataListOfCadetAtEventWithDinghies(db_connection, object_store)
sql_qualifications = SqlDataListOfQualifications(db_connection, object_store)
sql_cadets_with_qualifications = SqlListOfCadetsWithQualifications(db_connection, object_store)
...
sql_volunteers_with_roles = SqlDataListOfVolunteersInRolesAtEvent(db_connection, object_store)
sql_teams_and_roles = SqlDataListOfTeamsAndRolesWithIds(db_connection, object_store)
sql_club_dinghies_with_cadets = SqlDataListOfCadetAtEventWithClubDinghies(db_connection, object_store)
sql_club_dinghies_with_volunteers = SqlDataListOfVolunteersAtEventWithClubDinghies(db_connection, object_store)
...
sql_template_field_mappings = SqlDataWAFieldMappingTemplates(db_connection, object_store)
sql_mapped_registration_data = SqlDataMappedRegistrationData(db_connection, object_store)
sql_event_warnings = SqlDataListOfEventWarnings(db_connection, object_store)
sql_identified_cadets_at_event = SqlDataListOfIdentifiedCadetsAtEvent(db_connection, object_store)
...
sql_list_of_volunteers_at_event = SqlDataListOfVolunteersAtEvent(db_connection, object_store)
sql_identified_volunteers_at_event =SqlDataListOfIdentifiedVolunteersAtEvent(db_connection, object_store)
sql_club_boat_limits = SqlDataListOfClubDinghyLimits(db_connection, object_store)
sql_volunteers_with_patrol_boats = SqlDataListOfVolunteersAtEventWithPatrolBoats(db_connection, object_store)
...
sql_list_of_cadets_with_food_requirements = SqlDataListOfCadetsWithFoodRequirementsAtEvent(db_connection, object_store)
sql_list_of_volunteers_with_food_requirements = SqlDataListOfVolunteersWithFoodRequirementsAtEvent(db_connection, object_store)
...
sql_patrol_boat_labels = SqlDataListOfPatrolBoatLabelsAtEvent(db_connection, object_store)
sql_last_volunteer_roles = SqlDataListOfLastRolesAcrossEventsForVolunteers(db_connection, object_store)
