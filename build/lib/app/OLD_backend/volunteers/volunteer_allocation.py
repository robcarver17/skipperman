...
def get_list_of_volunteers_associated_with_cadet(
    ...
    return volunteer_data.get_list_of_volunteers_connected_to_cadet(cadet_id)
...
def relevant_information_requires_clarification_or_cadets_not_permanently_connected(
    ...
    volunteer_name = DEPRECATE_get_volunteer_from_id(
...
def get_list_of_volunteer_names_associated_with_cadet_at_event(
    data_layer: DataLayer, cadet_id: str, event: Event
):
    list_of_volunteer_ids = get_volunteer_ids_associated_with_cadet_at_specific_event(
        data_layer=data_layer, event=event, cadet_id=cadet_id
    )
    volunteer_names = [
        get_volunteer_from_id(data_layer=data_layer, volunteer_id=volunteer_id).name
...
def get_list_of_active_connected_cadets_at_event_for_volunteer(
    ...
    return active_connected_cadets
