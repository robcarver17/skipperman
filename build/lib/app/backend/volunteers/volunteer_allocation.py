...
from app.backend.data.volunteer_allocation import DEPRECATED_save_list_of_volunteers_at_event
...
from app.backend.data.volunteer_allocation import DEPRECATED_load_list_of_volunteers_at_event, \
    DEPRECATED_load_list_of_identified_volunteers_at_event, DEPRECATED_save_list_of_identified_volunteers_at_event,\
    update_volunteer_at_event, get_volunteer_at_event

from app.backend.cadets import DEPRECATED_cadet_name_from_id
from app.backend.volunteers.volunteers import DEPRECATE_list_of_similar_volunteers
from app.backend.wa_import.update_cadets_at_event import mark_cadet_at_event_as_unchanged, \
    DEPRECATE_get_cadet_at_event_for_cadet_id
from app.backend.volunteers.volunter_relevant_information import get_relevant_information_for_volunteer_in_event_at_row_and_index
...
def add_identified_volunteer(volunteer_id:str,
    ...
    DEPRECATED_save_list_of_identified_volunteers_at_event(list_of_volunteers=list_of_volunteers, event=event)
...
def get_list_of_relevant_voluteers(volunteer: Volunteer,
    ...
    list_of_volunteers_with_similar_name = DEPRECATE_list_of_similar_volunteers(volunteer=volunteer)
...
def get_list_of_volunteers_associated_with_cadet(cadet_id: str) -> list:
    list_of_cadet_volunteer_associations = DEPRECATE_get_list_of_cadet_volunteer_associations()
...
def is_current_cadet_active_at_event(cadet_id: str, event: Event)-> bool:
    cadet_at_event = DEPRECATE_get_cadet_at_event_for_cadet_id(event=event, cadet_id=cadet_id)
...
def list_of_volunteers_for_cadet_identified(cadet_id: str, event: Event) -> List[str]:
    list_of_identified_volunteers_at_event = DEPRECATED_load_list_of_identified_volunteers_at_event(event=event)
