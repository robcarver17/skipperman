    ...
    auto_layout_buttons = Line(
        ...
        + [
            Button(
                ...
                value=value_for_auto_layout_button(arrangement_description),
            )
...
def change_arrangement_given_method_and_current_order(
    ...
    arrangement_method_name = get_arrangement_description_given_button(
...
def is_auto_layout_button(button_value: str):
    return is_button_of_type(
        value_of_button_pressed=button_value,
        type_to_check=button_type_arrange_description,
    )


def value_for_auto_layout_button(description: str):
    return get_button_value_given_type_and_attributes(
        button_type_arrange_description, description
    )
