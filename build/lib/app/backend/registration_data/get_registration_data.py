...
def get_list_of_cadets_with_registration_data(object_store: ObjectStore,
...
def update_list_of_cadets_with_registration_data(object_store: ObjectStore,
                                                 event: Event, list_of_cadets_with_registration_data: DictOfCadetsWithRegistrationData):

    object_store.update(new_object=list_of_cadets_with_registration_data,
