...
def display_form_merge_delete_cadets(interface: abstractInterface):
    ...
    table_of_cadets_with_buttons = get_table_of_cadets_with_buttons(interface=interface)
...
def post_form_merge_delete_individual_cadet(
...
def launch_merge_cadet_process(interface: abstractInterface) -> Union[Form, NewForm]:
    cadet_to_merge_with = cadet_from_button_pressed(
        value_of_button_pressed=interface.last_button_pressed(),
        object_store=interface.object_store,
    )
