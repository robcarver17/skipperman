...
class FoodData():
    ...
    def change_food_requirements_for_cadet(self, event: Event, cadet_id: str, food_requirements: FoodRequirements):
        list_of_requirements =self.get_list_of_cadets_with_food_at_event(event)
        list_of_requirements.change_food_requirements_for_cadet(cadet_id=cadet_id, food_requirements=food_requirements)
        self.save_list_of_cadets_with_food_at_event(event=event, list_of_cadets_with_food_requirements=list_of_requirements)

    def change_food_requirements_for_volunteer(self, event: Event, volunteer_id: str, food_requirements: FoodRequirements):
        list_of_requirements =self.get_list_of_volunteeers_with_food_at_event(event)
        list_of_requirements.change_food_requirements_for_volunteer(volunteer_id=volunteer_id, food_requirements=food_requirements)
        self.save_list_of_volunteers_with_food_at_event(event=event,list_of_volunteers_with_food_requirements=list_of_requirements)
    ...
    def add_new_volunteer_with_food_to_event(
        ...
        list_of_requirements =self.get_list_of_volunteeers_with_food_at_event(event)
        list_of_requirements.add_new_volunteer_with_food_to_event(volunteer_id=volunteer_id, food_requirements=food_requirements)
        self.save_list_of_volunteers_with_food_at_event(event=event, list_of_volunteers_with_food_requirements=list_of_requirements)
    ...
    def list_of_active_cadets_with_food_at_event(self, event: Event) -> ListOfCadetsWithFoodRequirementsAtEvent:
        ...
        return list_of_requirements.filter_for_list_of_cadet_ids(list_of_active_cadet_ids)

    def list_of_active_volunteers_with_food_at_event(self, event: Event) -> ListOfVolunteersWithFoodRequirementsAtEvent:
        list_of_requirements = self.get_list_of_volunteeers_with_food_at_event(event)
        ...
        return list_of_requirements.filter_for_list_of_volunteer_ids(list_of_volunteer_ids)
    ...
    def save_list_of_volunteers_with_food_at_event(self, event: Event, list_of_volunteers_with_food_requirements: ListOfVolunteersWithFoodRequirementsAtEvent):
        self.data_api.save_list_of_volunteers_with_food_at_event(event=event, list_of_volunteers_with_food=list_of_volunteers_with_food_requirements)
    ...
    def save_list_of_cadets_with_food_at_event(self, event: Event, list_of_cadets_with_food_requirements: ListOfCadetsWithFoodRequirementsAtEvent):
