...
def get_summary_list_of_boat_allocations_for_day_by_boat(
    ...
    return [
        len(
            list_of_voluteers_at_event_with_patrol_boats.list_of_volunteer_ids_assigned_to_boat_and_day(
...
def get_volunteer_ids_allocated_to_patrol_boat_at_event_on_days_sorted_by_role(
