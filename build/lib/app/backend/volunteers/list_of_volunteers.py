...
def get_volunteer_with_matching_name(
    ...
    return object_store.get(
        object_store.data_api.data_list_of_volunteers.get_matching_volunteer,
        volunteer=volunteer,
        default=default,
    )
...
def get_volunteer_from_name(
    ...
    return list_of_volunteers.volunteer_with_matching_name(
        volunteer_name, default=default
    )


def get_volunteer_from_id(
    object_store: ObjectStore, volunteer_id: str, default=missing_data
) -> Volunteer:
    return object_store.get(
        object_store.data_api.data_list_of_volunteers.get_volunteer_from_id,
...
def get_sorted_list_of_volunteers(
    ...
    master_list = object_store.get(
        object_store.data_api.data_list_of_volunteers.read,
        sort_by=sort_by,
...
def delete_volunteer(
    ...
    try:
        interface.update(
            interface.object_store.data_api.data_list_of_volunteers.delete_volunteer,
            volunteer=volunteer,
        )
