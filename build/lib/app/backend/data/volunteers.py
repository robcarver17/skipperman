...
from app.objects.volunteer_skills import SkillsDict, ListOfVolunteerSkills, Skill
...
class VolunteerData:
    ...
    def confirm_volunteer_with_id_can_drive(self, volunteer_id: str):
        skills = self.get_list_of_volunteer_skills()
        skills.add_volunteer_driving_qualification(volunteer_id)
        self.save_list_of_volunteer_skills(skills)

    def remove_driving_qualification_for_volunteer_with_id(self, volunteer_id: str):
        skills = self.get_list_of_volunteer_skills()
        skills.remove_volunteer_driving_qualification(volunteer_id)
        self.save_list_of_volunteer_skills(skills)

    def save_skills_for_volunteer(self, volunteer: Volunteer, dict_of_skills: SkillsDict):
        all_skills = self.get_list_of_volunteer_skills()
    ...
    def get_list_of_volunteers_associated_with_cadet(self, cadet_id: str) -> ListOfVolunteers:
