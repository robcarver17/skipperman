...
from app.logic.events.patrol_boats.parse_patrol_boat_table import get_all_copy_buttons_for_rota, \
    update_if_copy_button_pressed, update_if_save_button_pressed_in_allocation_page, update_adding_boat
from app.logic.events.patrol_boats.render_patrol_boat_table import get_patrol_boat_table, ADD_NEW_BOAT_BUTTON_LABEL
