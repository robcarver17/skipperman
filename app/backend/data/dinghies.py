...
class DinghiesData():
    ...
    def update_club_boat_allocation_for_cadet_at_event_on_day(self, boat_name: str,
        ...
        if boat_name == NO_BOAT:
            ...
            cadets_with_club_dinghies_at_event.update_allocation_for_cadet_on_day(cadet_id=cadet_id, club_dinghy_id=boat_id, day=day)

        self.save_list_of_cadets_at_event_with_club_dinghies(list_of_cadets_at_event_with_club_dinghies=cadets_with_club_dinghies_at_event,
                                                             event=event)

    def update_boat_info_for_updated_cadets_at_event(self, event: Event,
        ...
        self.save_list_of_cadets_at_event_with_dinghies(list_of_cadets_at_event_with_dinghies=list_of_cadets_at_event_with_dinghies,event=event)
    ...
    def list_of_club_dinghies_bool_for_list_of_cadet_ids(self, event: Event, list_of_cadet_ids: List[str]) ->List[bool]:
        ...
        index_of_cadet_ids_in_list = [list_of_cadets_at_event_with_club_dinghies.DEPRECATE_dinghy_for_cadet_id(cadet_id=cadet_id,
    ...
    def save_list_of_cadets_at_event_with_club_dinghies(self, event: Event, list_of_cadets_at_event_with_club_dinghies: ListOfCadetAtEventWithClubDinghies):
        self.data_api.save_list_of_cadets_at_event_with_club_dinghies(event=event, list_of_cadets_at_event_with_club_dinghies=list_of_cadets_at_event_with_club_dinghies)
    ...
    def save_list_of_cadets_at_event_with_dinghies(self, event: Event, list_of_cadets_at_event_with_dinghies: ListOfCadetAtEventWithDinghies):
        self.data_api.save_list_of_cadets_at_event_with_dinghies(list_of_cadets_at_event_with_dinghies=list_of_cadets_at_event_with_dinghies, event=event
                                                                 )
...
def get_sorted_list_of_boats_excluding_boats_already_at_event(interface: abstractInterface, event: Event) -> ListOfPatrolBoats:
