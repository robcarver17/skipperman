...
from app.objects.reporting_options import describe_arrangement, POSSIBLE_ARRANGEMENTS, ARRANGE_PASSED_LIST
...
def post_form_for_group_arrangement_options(interface: abstractInterface) -> Union[NewForm, Form]:
    ...
    if last_button_pressed == USE_THIS_OPTIONS_BUTTON_LABEL:
        ...
        if arrangement == ARRANGE_PASSED_LIST:
            ## GET A DEFAULT LIST AND SAVE TO STATE, THEN NEXT TIME WE WILL SEE IT
            pass
