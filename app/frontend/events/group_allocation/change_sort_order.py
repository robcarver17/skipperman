...
def display_change_sort_order(interface: abstractInterface):
    ...
    keep_helm_and_crew_together = yes_no_radio(
        input_name=HELM_AND_CREW_TOGETHER,
...
def change_sort_order_and_save(interface: abstractInterface):
    ...
    new_sort_order = SortOrderGroups(
        new_sort_order_list, keep_pairs_together=keep_pairs_together
    )
