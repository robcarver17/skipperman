...
SAVE_WITH_BLANK_OTHER_BUTTON_LABEL = "Save tickboxes and blank out 'other' field"
...
def display_form_for_new_cadet_food_requirements(
    ...
    blank_other_button = Button(SAVE_WITH_BLANK_OTHER_BUTTON_LABEL)
    ...
    form = Form(
        ListOfLines(
            ...
            ]+food_inputs+[save_button, blank_other_button]
        ).add_Lines()
    )
...
def post_form_interactively_update_food_for_cadets_at_event(
    ...
    if last_button==SAVE_WITH_BLANK_OTHER_BUTTON_LABEL:
        food_requirements.other = ""
