...
def save_dict_of_df_as_spreadsheet_file(dict_of_df: Dict[str, pd.DataFrame], path_and_filename_no_extension: str):
    try:
        path_and_filename_with_extension = save_dict_of_df_as_xls(dict_of_df, path_and_filename_no_extension)
    except:
        path_and_filename_with_extension = save_dict_of_df_as_csv(dict_of_df, path_and_filename_no_extension)

    return path_and_filename_with_extension

def save_dict_of_df_as_xls(dict_of_df: Dict[str, pd.DataFrame], path_and_filename_without_extension: str):
...
def save_dict_of_df_as_csv(dict_of_df: Dict[str, pd.DataFrame], path_and_filename_without_extension: str):
