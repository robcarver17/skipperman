...
from app.data_access.file_access import PathAndFilename, delete_all_files_matching_filename, \
    web_pathname_of_public_version_of_local_file_without_extension, get_public_filename_given_local_file, add_suffix_to_public_filename
...
def web_pathname_of_public_version_of_local_report_file(print_options: PrintOptions):
    ...
    return web_pathname_of_public_version_of_local_file_without_extension(path_and_filename=local_file, public_path=PUBLIC_REPORTING_SUBDIRECTORY,
...
def delete_existing_public_files(download_path_and_filename: PathAndFilename):
    delete_all_files_matching_filename(filename=download_path_and_filename.filename_without_extension,
...
def copy_local_file_to_public_directory(local_path_and_filename: PathAndFilename):
    ...
    output_path_and_filename = get_public_filename_with_suffix_given_local_file(local_path_and_filename)
...
def get_public_filename_with_suffix_given_local_file(local_path_and_filename: PathAndFilename) -> PathAndFilename:
    output_path_and_filename =get_public_filename_given_local_file(local_path_and_filename, public_path=public_reporting_directory)
