...
from app.logic.allocation.load_and_save_allocations_for_events import load_allocation_for_event
...
def get_df_for_reporting_allocations_with_flags(event: Event, display_full_names: bool = False, include_unallocated_cadets: bool = False):
