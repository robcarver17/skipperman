...
from app.interface.events.constants import ADD_EVENT_BUTTON_LABEL, ADD_EVENT_STAGE, all_sort_types, VIEW_EVENT_STAGE, WA_IMPORT_SUBSTAGE_IN_VIEW_EVENT_STAGE
...
from app.interface.events.specific_event.wa_import import post_response_to_wa_import
...
def generate_event_pages(state_data: StateDataForAction) -> Html:
    ...
    elif state_data.stage == WA_IMPORT_SUBSTAGE_IN_VIEW_EVENT_STAGE:
        print("post response to WA import")
