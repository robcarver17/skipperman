...
from app.frontend.events.volunteer_rota.volunteer_rota_buttons import (
    ...
    access_copy_menu,
    quick_report_button,
    update_most_common_role_button, update_warnings_button,
)
...
def is_a_form_change_that_changes_state(last_button_pressed: str):
    return (
        last_button_pressed_was_volunteer_name_button(last_button_pressed)
        or is_button_sort_order(last_button_pressed)
        or clear_filter_button.pressed(last_button_pressed)
        or apply_filter_button.pressed(last_button_pressed)
    )


def is_a_form_change_that_changes_underlying_data(last_button_pressed: str):
    return (
        last_button_pressed_was_make_available_button(last_button_pressed)
        or last_button_pressed_was_make_unavailable_button(last_button_pressed)
        or last_button_pressed_was_remove_role_button(last_button_pressed)
        or last_button_pressed_was_copy_button(last_button_pressed)
        or last_button_pressed_was_swap_button(last_button_pressed)
        or save_menu_button.pressed(last_button_pressed)
        ...
        or update_warnings_button.pressed(last_button_pressed)
...
def is_a_form_change_that_returns_a_new_form(last_button_pressed: str):
    return (
        cancel_menu_button.pressed(last_button_pressed)
        or download_matrix_button.pressed(last_button_pressed)
        or add_volunteer_button.pressed(last_button_pressed)
        or last_button_pressed_was_location_button(last_button_pressed)
        or last_button_pressed_was_skill_button(last_button_pressed)
        or access_copy_menu.pressed(last_button_pressed)
        or quick_report_button.pressed(last_button_pressed)
    )
