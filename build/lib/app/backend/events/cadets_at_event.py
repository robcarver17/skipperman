...
def get_health_notes_for_list_of_cadets_at_event(
    ...
    all_event_info = get_dict_of_all_event_info_for_cadets(object_store=object_store, event=event, active_only=True)

    health_notes = []
    for cadet_at_event in list_of_cadets:
        registration_data = all_event_info.dict_of_cadets_with_registration_data.registration_data_for_cadet(cadet_at_event)
...
def get_attendance_matrix_for_list_of_cadets_at_event(
    ...
    for cadet in list_of_cadets:
        cadet_at_event_data = all_event_info.dict_of_cadets_with_registration_data.get(cadet, None)
