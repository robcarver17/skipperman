...
class DictOfDaysBoatClassAndPartners(Dict[Day, BoatClassAndPartnerAtEventOnDay]):
    ...
    def list_of_partners_across_days(self):
        list_of_partners = [
            ...
            for boat_class_and_partner in self.values()
            if valid_partnership_given_partner_cadet(
                boat_class_and_partner.partner_cadet
            )
        ]
    ...
    def partner_id_on_day(self, day: Day, default=NO_CADET_ID) -> str:
    ...
    def partner_on_day(self, day: Day, default=no_partner_allocated) -> [Cadet, object]:
        boat_class_and_partner = self.boat_class_and_partner_on_day(
            day, default=missing_data
        )
        if boat_class_and_partner is missing_data:
...
class _InternalListOfBoatGroupings(List[BoatGrouping]):
    def does_cadet_with_id_have_edit_rights_given_partner_id(
        self, cadet_id: str, partner_id: str
    ):
        ...
        return existing_boat.is_first_id(
            cadet_id
        )  ## should always be False, but you never know
...
class ListOfBoatGroupings:
    def __init__(
        self,
        dict_of_cadets_boat_classes_and_partners: DictOfCadetsAndBoatClassAndPartners,
    ):
        self._dict_of_cadets_boat_classes_and_partners = (
            dict_of_cadets_boat_classes_and_partners
        )
    ...
    def does_cadet_have_edit_rights_on_day(self, cadet: Cadet, day: Day):
        ...
        return self.does_cadet_with_id_have_edit_rights_given_partner_id(
            cadet.id, partner_id
        )
    ...
    def does_cadet_with_id_have_edit_rights_given_partner_id(
        ...
        if partner_id == NO_CADET_ID:
            ...
            return self.list_of_boat_groupings.does_cadet_with_id_have_edit_rights_given_partner_id(
                cadet_id=cadet_id, partner_id=partner_id
            )
    ...
    def partner_id_for_cadet_across_days(self, cadet: Cadet):
        return self.boat_classes_and_partner_for_cadet(
            cadet
        ).get_most_common_partner_id_across_days(default=NO_CADET_ID)

    def partner_id_for_cadet_on_day(self, cadet: Cadet, day: Day):
        return self.boat_classes_and_partner_for_cadet(cadet).partner_id_on_day(
            day, default=NO_CADET_ID
        )

    def boat_classes_and_partner_for_cadet(self, cadet: Cadet):
        return self.dict_of_cadets_boat_classes_and_partners.boat_classes_and_partner_for_cadet(
            cadet
        )

    @property
    def dict_of_cadets_boat_classes_and_partners(
        self,
