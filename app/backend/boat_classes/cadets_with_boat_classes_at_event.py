...
def get_dict_of_cadets_and_boat_classes_and_partners_at_events(
    ...
    return object_store.get(
        object_store.data_api.data_list_of_cadets_with_dinghies_at_event.get_dict_of_cadets_and_boat_classes_and_partners_at_events,
        event_id=event.id,
    )
...
def remove_cadet_from_boats_data_on_day_and_return_messages(
    ...
    dict_of_cadets_and_boat_classes_and_partners_at_event = (
        get_dict_of_cadets_and_boat_classes_and_partners_at_events(
            object_store=interface.object_store, event=event
        )
    )
    boat_classes_and_partner_on_day = dict_of_cadets_and_boat_classes_and_partners_at_event.boat_classes_and_partner_for_cadet(
        cadet
