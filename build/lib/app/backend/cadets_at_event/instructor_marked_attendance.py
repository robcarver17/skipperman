...
def get_attendance_at_event_for_cadets_in_group_at_event(
    ...
    cadets_in_group = get_list_of_cadets_in_group(
...
def mark_unknown_cadets_as_not_attending_or_unregistered(
    ...
    attendance_dict = get_attendance_on_day_for_cadets_in_group(
        object_store=interface.object_store, event=event, day=day, group=group
    )
...
def update_attendance_for_cadet_on_day_at_event(
    ...
    interface.update(
        interface.object_store.data_api.data_attendance_at_events_for_specific_cadet.update_attendance_for_cadet_on_day_at_event,
        cadet_id=cadet.id,
...
def are_all_cadets_in_group_marked_in_registration_as_present_absent_or_late(
    ...
    requires_save = [
        attendance.current_attendance == registration_not_taken
        or attendance.current_attendance == unknown
