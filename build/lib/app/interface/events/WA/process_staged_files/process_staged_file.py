...
from app.interface.events.WA.process_staged_files.wa_iteratively_add_cadet_ids import \
    process_rows_of_unmapped_data_and_then_move_to_event_scan
from app.interface.events.WA.utils import delete_staged_file_for_current_event, get_event_from_state

from app.interface.flask.state_for_action import StateDataForAction

from app.logic.events.load_wa_file import get_raw_event_filename
from app.logic.events.map_wa_fields import map_wa_fields_in_df_for_event
from app.logic.events.update_mapped_wa_event_data_with_cadet_ids import \
...
def process_wa_staged_file_already_uploaded(state_data: StateDataForAction):
    ...
    filename = get_raw_event_filename(event.id)
