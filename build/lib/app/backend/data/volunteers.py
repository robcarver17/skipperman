...
class VolunteerData:
    ...
    def get_dict_of_existing_skills_for_volunteer(
        ...
        return self.get_dict_of_existing_skills_for_volunteer_id(
            volunteer_id=volunteer.id
        )

    def get_dict_of_existing_skills_for_volunteer_id(
    ...
    def get_list_of_volunteer_ids_with_boat_skills(self) -> List[str]:
        ...
        list_of_volunteer_ids_with_boat_skills = (
            volunteer_skills.list_of_volunteer_ids_with_boat_related_skill()
        )
    ...
    def get_list_of_volunteers_associated_with_cadet(self, cadet_id: str) -> list:
        ...
        list_of_volunteers_associated_with_cadet = [
            list_of_all_volunteers.object_with_id(volunteer_id)
