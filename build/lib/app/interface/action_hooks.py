...
from app.interface.flask.state_for_action import (
    get_state_data_for_action,
    StateDataForAction,
)
...
class SiteActions:
    ...
    def get_html_for_action(self, action_name: str) -> Html:
        try:
            ...
            html_code_for_action = (
                self._get_html_for_action_without_checking_for_method(
    ...
    def _get_html_for_action_without_checking_for_method(
        self, action_name: str, method_to_get_html_code
    ) -> Html:
        if DEBUG:
