...
def set_all_temporary_unconfirmed_members_to_lapsed_and_return_list(object_store: ObjectStore) -> ListOfCadets:
    list_of_cadets = get_list_of_cadets(object_store)
    lapsed_members = list_of_cadets.set_all_temporary_unconfirmed_members_to_lapsed_and_return_list()
    update_list_of_cadets(object_store=object_store, updated_list_of_cadets=list_of_cadets)

    return lapsed_members

def set_all_user_unconfirmed_members_to_non_members_and_return_list(object_store: ObjectStore) -> ListOfCadets:
    list_of_cadets = get_list_of_cadets(object_store)
    lapsed_members = list_of_cadets.set_all_user_unconfirmed_members_to_non_members_and_return_list()
    update_list_of_cadets(object_store=object_store, updated_list_of_cadets=list_of_cadets)
