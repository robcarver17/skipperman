...
from app.backend.group_allocations_data import (
    AllocationData, get_allocation_data,
)
from app.backend.cadet_event_allocations import save_current_allocations_for_event
...
dict_of_all_possible_groups_for_dropdown_input= dict([(group, group) for group in ALL_GROUPS])
