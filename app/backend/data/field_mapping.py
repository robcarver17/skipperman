...
def get_list_of_templates():
    return DEPRECATED_data.data_wa_field_mapping.get_list_of_templates()


def get_template(template_name):
    return DEPRECATED_data.data_wa_field_mapping.get_template(template_name)


def write_template(template_name, new_mapping):
    DEPRECATED_data.data_wa_field_mapping.write_template(
