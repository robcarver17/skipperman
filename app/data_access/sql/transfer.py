...
sql_qualifications = SqlDataListOfQualifications(master_data_path=master_data_path, backup_data_path=backup_data_path)
sql_cadets_with_qualifications = SqlListOfCadetsWithQualifications(master_data_path=master_data_path, backup_data_path=backup_data_path)
