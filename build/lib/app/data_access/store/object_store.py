...
from app.data_access.store.object_store_elements import  DefinitionWithArgsAndMethod, CachedDataItem
...
class ObjectStore:
    ...
    def update_without_checking_read_only(self, data_api_property_and_method: Callable, **kwargs):
