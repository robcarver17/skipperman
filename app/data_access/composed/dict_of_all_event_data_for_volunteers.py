...
from app.objects.composed.volunteer_with_group_and_role_at_event import \
    DictOfVolunteersAtEventWithDictOfDaysRolesAndGroups, DictOfDaysRolesAndGroupsAndTeams
...
from app.objects.composed.volunteers_with_skills import DictOfVolunteersWithSkills, SkillsDict
from app.objects.events import  Event
from app.objects.volunteers import Volunteer


class ComposedDataAllEventInfoForVolunteers(ComposedBaseData):
    def get_dict_of_all_event_info_for_volunteers(self, event: Event) -> DictOfAllEventDataForVolunteers :
        ...
        dict_of_volunteers_at_event_with_days_and_roles = self.object_store.get(self.object_store.data_api.data_list_of_volunteers_in_roles_at_event.get_dict_of_volunteers_with_roles_and_groups_at_event, event_id=event.id)
        ...
        dict_of_cadets_associated_with_volunteers = self.object_store.get(self.object_store.data_api.data_list_of_cadet_volunteer_associations.get_dict_of_cadets_associated_with_volunteers)

        dict_of_people_and_club_dinghies_at_event = self.object_store.get(self.object_store.data_api.data_list_of_volunteers_at_event_with_club_dinghies.read_dict_of_volunteers_and_club_dinghies_at_event,
                            event_id=event.id)
