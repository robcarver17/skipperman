...
LIST_OF_VOLUNTEER_FIELDS = [
    dict(
AVAILABILITY = VOLUNTEER1_AVAILABILITY,
WEEKEND_AVAILABILITY = VOLUNTEER1_WEEKEND_AVAILABILITY,
NAME = VOLUNTEER1_NAME,
DUTIES= VOLUNTEER1_DUTIES,
SAME_OR_VARIED = VOLUNTEER1_SAME_OR_VARIED,
FOOD_PREFERENCE= VOLUNTEER1_FOOD_PREFERENCE),

    dict(
AVAILABILITY = VOLUNTEER2_AVAILABILITY,
WEEKEND_AVAILABILITY = VOLUNTEER2_WEEKEND_AVAILABILITY,
NAME = VOLUNTEER2_NAME,
DUTIES= VOLUNTEER2_DUTIES,
SAME_OR_VARIED = VOLUNTEER2_SAME_OR_VARIED,
FOOD_PREFERENCE= VOLUNTEER2_FOOD_PREFERENCE)
