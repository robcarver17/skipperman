from app.logic.utilities.files.state import retrieve_directory_and_filename, clear_directory_and_filename
import os
...
def post_form_to_replace_selected_files(interface: abstractInterface):
    ...
    if last_button == CANCEL_BUTTON_LABEL:
        previous_form = interface.get_new_display_form_for_parent_of_function(display_form_to_replace_selected_files)
