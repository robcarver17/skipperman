...
def save_emergency_contact_parameter(interface: abstractInterface, parameters: AdditionalParametersForRollcallReport):
    interface.set_persistent_value(EMERGENCY_CONTACTS, parameters.incude_emergency_contacts)

def save_include_health_details_parameter(interface: abstractInterface, parameters: AdditionalParametersForRollcallReport):
...
def load_additional_parameters_for_rollcall_report(
    ...
    include_emergency_contacts = interface.get_persistent_value(EMERGENCY_CONTACTS, True)
