...
def get_list_of_cadets_given_list_of_ids(data_and_interface: DataAndInterface,
                                         list_of_cadet_ids: list) -> ListOfCadets:
    master_list_of_cadets = load_master_list_of_cadets(data_and_interface=data_and_interface)
...
def get_list_of_cadet_ids_in_mapped_wa_event(
    ...
    list_of_cadet_ids = mapped_wa_event_data_without_duplicates.list_of_cadet_ids_with_given_status(
        exclude_cancelled=exclude_cancelled,
        exclude_deleted=exclude_deleted,
        exclude_active=exclude_active
    )
