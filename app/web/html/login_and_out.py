...
logout_html_string = '<a href="/%s" class="w3-bar-item w3-button w3-padding-16">Logout</a>' % LOGOUT_URL
change_password_html_string = '<a href="/%s" class="w3-bar-item w3-button w3-padding-16">Change password</a>' % CHANGE_PASSWORD
