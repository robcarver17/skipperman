...
def summarise_generic_counts_for_event(event: Event,
...
def get_row_for_group(group, event: Event,
    ...
    counts= [get_count_on_day_for_group(list_of_ids_for_group=list_of_ids_for_group,
...
def get_count_on_day_for_group(list_of_ids_for_group: list,
                               availability_dict: Dict[str, DaySelector],
                               day: Day) -> int:
