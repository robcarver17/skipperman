...
class CsvDataListOfIdentifiedCadetsAtEvent(GenericCsvData):
...
class CsvDataAttendanceAtEventsForSpecificCadet(GenericCsvData):
...
class CsvDataListOfGroupNamesForEventsAndCadetPersistentVersion(GenericCsvData):
    ...
    def write(
        self, list_of_groups: ListOfGroupNamesForEventsAndCadetPersistentVersionWithIds
    ):
        self.write_object(
            list_of_groups,
            file_identifier=GROUP_NAMES_ACROSS_EVENTS_FOR_CADETS_PERSISTENT_READ_ONLY,
