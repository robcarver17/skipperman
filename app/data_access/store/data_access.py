...
class DataLayer:
    ...
    def delete_all_data(self, are_you_sure: bool = False):
        self.data.delete_all_master_data(are_you_sure=are_you_sure)
    ...
    def get_list_of_boat_classes(self) -> ListOfBoatClasses:
        data_access_for_list_of_dinghies = get_data_access_for_list_of_boat_classes(
            self.data
        )
    ...
    def get_list_of_cadet_volunteer_associations(
        ...
        data_access_for_list_of_cadet_volunteer_associations = (
            get_data_access_for_list_of_cadet_volunteer_associations_with_ids(self.data)
        )
