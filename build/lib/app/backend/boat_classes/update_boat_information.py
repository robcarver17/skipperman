...
def update_boat_class_sail_number_group_club_dinghy_and_partner_for_cadets_at_event(
    ...
    dict_of_all_event_info_for_cadets = (
        get_dict_of_all_event_info_for_cadets(
            object_store=object_store, event=event
        )
    )
    list_of_existing_cadets_boats_groups_club_dinghies_and_partners  = (
        dict_of_all_event_info_for_cadets.list_of_cadets_boat_classes_groups_sail_numbers_and_partners_at_event_on_day(day)
    )
    print_list(list_of_existing_cadets_boats_groups_club_dinghies_and_partners, "Existing:")
    ...
    print_list(list_of_potentially_updated_cadets_boats_groups_club_dinghies_and_partners, "Potential updates:")
    ...
    print_list(list_of_updated_cadets_boats_groups_club_dinghies_and_partners, "Actual updates:")
...
def convert_list_of_inputs_to_list_of_cadet_at_event_objects(
    ...
    dict_of_all_event_info_for_cadets: DictOfAllEventInfoForCadets,
        list_of_updates: List[CadetWithDinghySailNumberBoatClassAndPartner], day: Day
) -> ListOfCadetBoatClassClubDinghyGroupAndPartnerAtEventOnDay:
...
def convert_single_input_to_cadet_with_class_and_partner_at_event(
    object_store: ObjectStore,
    dict_of_all_event_info_for_cadets: DictOfAllEventInfoForCadets,
        update: CadetWithDinghySailNumberBoatClassAndPartner, day: Day
) -> CadetBoatClassClubDinghyGroupAndPartnerAtEventOnDay:
    cadet = update.cadet

    boat_class = get_boat_class_from_str(object_store=object_store, dict_of_all_event_info_for_cadets=dict_of_all_event_info_for_cadets,
                                         update=update, day=day)

    two_handed_partner = get_two_handed_partner_from_str(object_store=object_store, dict_of_all_event_info_for_cadets=dict_of_all_event_info_for_cadets,
                                         update=update, day=day)
    sail_number = get_sail_number_from_str(dict_of_all_event_info_for_cadets=dict_of_all_event_info_for_cadets,
                                         update=update, day=day)
    group = get_group_from_str(object_store=object_store, dict_of_all_event_info_for_cadets=dict_of_all_event_info_for_cadets,
                                         update=update, day=day)
    club_dinghy = get_club_dinghy_from_str(object_store=object_store, dict_of_all_event_info_for_cadets=dict_of_all_event_info_for_cadets,
                                         update=update, day=day)
...
def get_boat_class_from_str(
    ...
    if update.boat_class_name == MISSING_FROM_FORM:
        current_boat_class_partner_on_day = get_current_boat_class_partner_on_day_for_update(
            dict_of_all_event_info_for_cadets=dict_of_all_event_info_for_cadets,
            update=update,
            day=day
        )
...
def get_current_boat_class_partner_on_day_for_update(        dict_of_all_event_info_for_cadets: DictOfAllEventInfoForCadets,
        update: CadetWithDinghySailNumberBoatClassAndPartner, day: Day
) -> CadetBoatClassClubDinghyGroupAndPartnerAtEventOnDay:
    cadet = update.cadet
    dict_of_cadets_and_boat_classes_and_partners_at_events = dict_of_all_event_info_for_cadets.dict_of_cadets_and_boat_class_and_partners
    current_boat_class_partner_on_day = dict_of_cadets_and_boat_classes_and_partners_at_events.boat_classes_and_partner_for_cadet(
        cadet).boat_class_and_partner_on_day(day)
...
def get_two_handed_partner_from_str(
    ...
    if two_handed_partner_cadet_as_str == MISSING_FROM_FORM:
        ...
        two_handed_partner = get_two_handed_partner_from_str_in_form_not_missing(object_store=object_store, two_handed_partner_cadet_as_str=two_handed_partner_cadet_as_str)
...
def get_group_from_str(
    ...
    if group_name == MISSING_FROM_FORM:
        cadet = update.cadet
        group = dict_of_all_event_info_for_cadets.dict_of_cadets_with_days_and_groups.get_days_and_groups_for_cadet(cadet).group_on_day(day)
    else:
        group = get_group_with_name(
            object_store=object_store, group_name=group_name,
...
def get_club_dinghy_from_str(
    ...
    if update.club_boat_name == MISSING_FROM_FORM:
        cadet =update.cadet
        club_boat = dict_of_all_event_info_for_cadets.dict_of_cadets_and_club_dinghies_at_event.club_dinghys_for_cadet(cadet).dinghy_on_day(day)
    else:
        club_boat = get_club_dinghy_with_name(object_store=object_store, boat_name=club_boat_name, default=no_club_dinghy)
...
def update_boat_info_for_updated_cadets_at_event(
    ...
    for cadet_boat_class_group_club_dinghy_and_partner_on_day in list_of_updated_cadets_boats_groups_club_dinghies_and_partners:
