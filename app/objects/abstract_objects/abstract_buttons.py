...
from app.data_access.configuration.fixed import MAIN_MENU_KEYBOARD_SHORTCUT, HELP_KEYBOARD_SHORTCUT, BACK_KEYBOARD_SHORTCUT, CANCEL_KEYBOARD_SHORTCUT, SAVE_KEYBOARD_SHORTCUT
...
back_menu_button = Button(BACK_BUTTON_LABEL, nav_button=True, shortcut=BACK_KEYBOARD_SHORTCUT)
cancel_menu_button = Button(CANCEL_BUTTON_LABEL, nav_button=True, shortcut=CANCEL_KEYBOARD_SHORTCUT)
save_menu_button = Button(SAVE_BUTTON_LABEL, nav_button=True, shortcut=SAVE_KEYBOARD_SHORTCUT)