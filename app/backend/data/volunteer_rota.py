...
class VolunteerRotaData:
    ...
    def is_senior_instructor(self, event: Event, volunteer_id: str) -> bool:
        all_roles = [
            self.get_volunteer_with_role_at_event_on_day_from_id(
    ...
    def update_role_and_group_at_event_for_volunteer_on_all_days_when_available(
        self, volunteer_id: str, new_role_and_group: RoleAndGroup, event: Event
    ):
        list_of_volunteers_in_roles_at_event = (
            self.get_list_of_volunteers_in_roles_at_event(event)
        )
    ...
    def copy_across_duties_for_volunteer_at_event_from_one_day_to_all_other_days(
        self, event: Event, volunteer_id: str, day: Day, allow_replacement: bool = True
    ):
        list_of_volunteers_in_roles_at_event = (
            self.get_list_of_volunteers_in_roles_at_event(event)
        )
    ...
    def get_volunteer_ids_in_boat_related_roles_on_day_of_event(
        ...
        volunteers_in_role_at_event = (
            self.get_volunteers_in_role_at_event_who_are_also_allocated_to_event(event)
        )
    ...
    def get_volunteer_with_role_at_event_on_day_for_volunteer_at_event(
        self, event: Event, volunteer_at_event: VolunteerAtEventWithId, day: Day
    ) -> VolunteerInRoleAtEvent:
    ...
    def get_volunteer_role_at_event_on_day_for_volunteer_id(
        ...
        volunteer_in_role = self.get_volunteer_with_role_at_event_on_day_from_id(
            event=event, day=day, volunteer_id=volunteer_id
        )
    ...
    def get_volunteer_with_role_at_event_on_day_from_id(
    ...
    def get_volunteers_in_role_at_event_who_are_also_allocated_to_event(
        self, event: Event
    ) -> ListOfVolunteersInRoleAtEvent:
    ...
    def save_list_of_volunteers_in_roles_at_event(
        self,
        event: Event,
        list_of_volunteers_in_role_at_event: ListOfVolunteersInRoleAtEvent,
    ):
