...
USE_ORIGINAL_DATA = "Use original data that we already have"
USE_NEW_DATA = "Use new data imported from WA file"
USE_DATA_IN_FORM = "Use data as edited in form above"
...
WA_INTERACTIVELY_REMOVE_SPECIFIC_DUPLICATES_FROM_WA_FILE = "WA_interactively_remove_specific_duplicates_from_wa_file"
