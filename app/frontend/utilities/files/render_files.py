...
from app.objects_OLD.abstract_objects.abstract_form import checkboxInput
...
public_file_header = ButtonBar(
    [
        Button(UPLOAD_PUBLIC_FILE, nav_button=True),
...
downloads_file_header = ButtonBar(
    [
        Button(CLEAR_TEMP_BUTTON_LABEL, nav_button=True),
        Button(DELETE_SELECTED_FILES, nav_button=True),
    ]
)
uploads_file_hedaer = ButtonBar(
    [
        Button(CLEAR_STAGING_BUTTON_LABEL, nav_button=True),
        Button(DELETE_SELECTED_FILES, nav_button=True),
    ]
)
