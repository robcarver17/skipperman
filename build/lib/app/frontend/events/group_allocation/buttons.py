...
reset_day_button = Button(
    RESET_DAY_BUTTON_LABEL,
    value=get_button_value_for_day_button_with_non_day_value(RESET_DAY_BUTTON_LABEL),
)
...
def make_cadet_available_button_name(cadet: Cadet):
    return get_button_value_given_type_and_attributes(
        MAKE_CADET_AVAILABLE_ON_DAY_BUTTON, cadet.id
    )
...
def cadet_id_from_cadet_available_buttons(button_str: str):
    return get_attributes_from_button_pressed_of_known_type(
        value_of_button_pressed=button_str,
        type_to_check=MAKE_CADET_AVAILABLE_ON_DAY_BUTTON,
    )
...
def get_button_for_partnership_cell(
    cadet: Cadet,
...
def button_name_for_delete_partner(cadet: Cadet):
    return get_button_value_given_type_and_attributes(
        delete_partner_button_type, cadet.id
    )


def was_remove_partner_button(buttone) -> bool:
    return is_button_of_type(
        type_to_check=delete_partner_button_type, value_of_button_pressed=buttone
    )


def was_add_partner_button(buttone) -> bool:
    return is_button_of_type(
        type_to_check=add_button_partner_type, value_of_button_pressed=buttone
    )
...
def get_cadet_given_remove_partner_button_name(object_store: ObjectStore, button: str):
    cadet_id = get_attributes_from_button_pressed_of_known_type(
        value_of_button_pressed=button, type_to_check=delete_partner_button_type
    )
...
def get_cadet_given_add_partner_button_name(object_store: ObjectStore, button: str):
    cadet_id = get_attributes_from_button_pressed_of_known_type(
        value_of_button_pressed=button, type_to_check=add_button_partner_type
    )
    return get_cadet_from_id(object_store=object_store, cadet_id=cadet_id)
