...
from app.data_access.store.DEPRECATE_cadets_with_groups_at_event import (
    CadetsWithGroupsAtEventData,
)
...
class VolunteersAtEventData:
    ...
    def get_list_of_volunteers_at_event_with_skills(
        ...
        all_volunteers_with_id_at_event = self.get_list_of_volunteers_with_id_at_event(
            event
        )

        list_of_volunteers_at_event = [
            self.get_volunteer_at_event_with_skills(
                event=event, volunteer_at_event_with_id=volunteer_at_event_with_id
            )
    ...
    def get_volunteer_at_event_with_skills(
        self, event: Event, volunteer_at_event_with_id: VolunteerAtEventWithId
    ) -> VolunteerAtEventWithSkills_DEPRECATE:
        volunteer = self.get_list_of_volunteers().volunteer_with_id(
            volunteer_at_event_with_id.volunteer_id
        )
        volunteer_skills = (
            self.get_list_of_volunteer_skills().dict_of_skills_for_volunteer_id(
                volunteer_at_event_with_id.volunteer_id
            )
        )
        list_of_associated_cadets = self.get_list_of_associated_cadets_at_event(
            event=event,
    ...
    def get_list_of_associated_cadets_at_event(
        self, event: Event, list_of_associated_cadet_id: List[str]
    ) -> ListOfCadetsAtEventWithGroupsByDay:
        list_of_cadets = [
    ...
    def get_associated_cadet_at_event(
        self, event: Event, cadet_id: str
    ) -> CadetAtEventWithGroupsByDay:
        list_of_cadets_at_event_with_groups_by_day = (
            self.get_list_of_cadets_at_event_with_groups_by_day(event)
        )
        return list_of_cadets_at_event_with_groups_by_day.cadet_at_event_with_groups_by_day_given_id(
            cadet_id=cadet_id
        )
    ...
    def get_list_of_cadets_at_event_with_groups_by_day(
        ...
        return self.cache.get_from_cache(
            get_list_of_cadets_at_event_with_groups_by_day, event=event
        )
    ...
    def get_list_of_volunteers_with_id_at_event(
        self, event: Event
    ) -> ListOfVolunteersAtEventWithId:
...
def get_list_of_cadets_at_event_with_groups_by_day(
    ...
    return (
        cadets_with_groups_at_event_data.get_list_of_cadets_at_event_with_groups_by_day(
            event
        )
    )
