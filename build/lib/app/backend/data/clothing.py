...
class ClothingData():
    ...
    def get_list_of_active_cadet_objects_with_clothing_at_event(self, event: Event, only_committee: bool=False) -> ListOfCadetObjectsWithClothingAtEvent:
        active_cadets_with_clothing =self.get_list_of_active_cadets_with_clothing_at_event(event=event, only_committee=only_committee)
    ...
    def get_list_of_active_cadets_with_clothing_at_event(self, event: Event, only_committee: bool=False) -> ListOfCadetsWithClothingAtEvent:
        ...
        if only_committee:
            ...
            cadets_with_clothing = cadets_with_clothing.filter_for_list_of_cadet_ids(committee_ids)

        active_cadets_with_clothing = cadets_with_clothing.filter_for_list_of_cadet_ids(active_cadets.list_of_ids)
    ...
    def list_of_current_cadet_committee(self) -> ListOfCadetsOnCommittee:
