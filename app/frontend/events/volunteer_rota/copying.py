...
def update_if_individual_copy_overwrite_button_pressed(
    ...
    volunteer, day = from_copyoverwrite_button_to_volunteer_and_day(interface.object_store, copy_button)
...
def update_if_individual_copy_fill_button_pressed(
    ...
    volunteer, day = from_copyfill_button_to_volunteer_and_day(interface.object_store, copy_button)
    event = get_event_from_state(interface)
    copy_across_duties_for_volunteer_at_event_from_one_day_to_all_other_days(
        object_store=interface.object_store,
        event=event,
