...
class GroupOrder(List[str]):
    ...
    def in_my_group_order_but_missing_from_other_group_order(self, other_group_order: 'GroupOrder'):
...
def get_group_order_excluding_missing_groups(dict_of_df, group_order: GroupOrder, specific_parameters_for_type_of_report: SpecificParametersForTypeOfReport) -> GroupOrder:
    group_order_from_df = get_group_order_from_dict_of_df_given_report_parameters(dict_of_df=dict_of_df,
...
def get_groups_in_dict_missing_from_group_order(dict_of_df, group_order: GroupOrder, specific_parameters_for_type_of_report: SpecificParametersForTypeOfReport) -> GroupOrder:
    group_order_from_df = get_group_order_from_dict_of_df_given_report_parameters(dict_of_df=dict_of_df,
                                                                                  specific_parameters_for_type_of_report=specific_parameters_for_type_of_report)
...
def get_groups_in_group_order_missing_from_dict(dict_of_df, group_order: GroupOrder, specific_parameters_for_type_of_report: SpecificParametersForTypeOfReport) -> GroupOrder:
    group_order_from_df = get_group_order_from_dict_of_df_given_report_parameters(dict_of_df=dict_of_df,
                                                                                  specific_parameters_for_type_of_report=specific_parameters_for_type_of_report)

    return group_order.in_my_group_order_but_missing_from_other_group_order(group_order_from_df)
