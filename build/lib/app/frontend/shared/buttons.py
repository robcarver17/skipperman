...
def is_button_day_select(value_of_button_pressed: str):
    return is_button_of_type(
        type_to_check=day_button_type, value_of_button_pressed=value_of_button_pressed
    )
...
def get_day_name_or_value_from_button_pressed(value_of_button_pressed: str):
    attributes = get_attributes_from_button_pressed_of_known_type(
        value_of_button_pressed=value_of_button_pressed, type_to_check=day_button_type
    )
    return attributes
...
def is_button_sort_order(value_of_button_pressed: str):
    return is_button_of_type(
        type_to_check=sort_button_type, value_of_button_pressed=value_of_button_pressed
    )


def sort_order_from_button_pressed(value_of_button_pressed: str):
    attributes = get_attributes_from_button_pressed_of_known_type(
        value_of_button_pressed=value_of_button_pressed, type_to_check=sort_button_type
    )
    return attributes
...
def get_button_value_for_volunteer_selection(volunteer: Volunteer):
    return get_button_value_given_type_and_attributes(
        volunteer_button_type, volunteer.id
    )


def is_button_volunteer_selection(value_of_button_pressed: str):
    return is_button_of_type(
        type_to_check=volunteer_button_type,
        value_of_button_pressed=value_of_button_pressed,
    )


def volunteer_from_button_pressed(
    object_store: ObjectStore, value_of_button_pressed: str
):
...
def is_button_cadet_selection(value_of_button_pressed: str):
    return is_button_of_type(
        type_to_check=cadet_button_type, value_of_button_pressed=value_of_button_pressed
    )
...
def cadet_id_from_button_pressed(value_of_button_pressed: str):
    return get_attributes_from_button_pressed_of_known_type(
        value_of_button_pressed=value_of_button_pressed, type_to_check=cadet_button_type
    )
...
def is_button_event_selection(value_of_button_pressed: str):
    return is_button_of_type(
        type_to_check=event_button_type, value_of_button_pressed=value_of_button_pressed
    )
...
def event_id_from_button_pressed(value_of_button_pressed: str):
    return get_attributes_from_button_pressed_of_known_type(
        value_of_button_pressed=value_of_button_pressed, type_to_check=event_button_type
    )
...
def get_type_and_attributes_from_button_pressed(
    value_of_button_pressed: str,
) -> List[str]:
...
def get_type_of_button_pressed(value_of_button_pressed: str):
    type_and_attributes = get_type_and_attributes_from_button_pressed(
        value_of_button_pressed
    )
...
def get_attributes_from_button_pressed_of_known_type(
    value_of_button_pressed: str, type_to_check: str, collapse_singleton=True
):
    type_and_attributes = get_type_and_attributes_from_button_pressed(
        value_of_button_pressed
    )
    ...
    if not type_of_button == type_to_check:
        raise Exception(
            "%s not of type %s instead %s"
            % (value_of_button_pressed, type_to_check, type_of_button)
        )
