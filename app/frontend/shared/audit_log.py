from app.backend.security.audit_logs import (
    ...
    get_list_of_audit_logs_for_all_events_newest_first,
)
...
def get_audit_log_to_display_for_event(interface: abstractInterface):
    ...
    audit_log = get_list_of_audit_logs_for_event_newest_first(
...
def get_audit_log_to_display_for_all_events(interface: abstractInterface):
    audit_log = get_list_of_audit_logs_for_all_events_newest_first(
