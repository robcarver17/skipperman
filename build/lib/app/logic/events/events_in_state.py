...
def get_event_from_list_of_events_given_event_description(interface: abstractInterface, event_description: str) -> Event:
    list_of_events = DEPRECATE_get_list_of_all_events(interface)
...
def update_state_for_specific_event_given_event_description(interface: abstractInterface, event_description: str):
    event = get_event_from_list_of_events_given_event_description(interface=interface, event_description=event_description)
