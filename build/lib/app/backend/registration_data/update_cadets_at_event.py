...
from app.backend.registration_data.cadet_registration_data import get_list_of_cadets_with_id_and_registration_data_at_event, update_list_of_cadets_with_id_and_registration_data_at_event


def no_important_difference_between_cadets_at_event(
    new_cadet_at_event_data: CadetWithIdAtEvent, existing_cadet_at_event_data: CadetWithIdAtEvent
) -> bool:
    ## only compare availability and status, as that is all WA can update

    status_matches = new_cadet_at_event_data.status == existing_cadet_at_event_data.status
    available_matches = (
        new_cadet_at_event_data.availability == existing_cadet_at_event_data.availability
    )
...
def replace_existing_cadet_at_event_where_original_cadet_was_inactive(
    ...
    list_of_cadets_with_id_at_event = get_list_of_cadets_with_id_and_registration_data_at_event(object_store=object_store, event=event)
...
def update_notes_for_existing_cadet_at_event(
    ...
    list_of_cadets_with_id_at_event = get_list_of_cadets_with_id_and_registration_data_at_event(object_store=object_store, event=event)
    list_of_cadets_with_id_at_event.update_notes_for_existing_cadet_at_event(cadet_id=cadet.id, new_notes=new_notes)
    update_list_of_cadets_with_id_and_registration_data_at_event(object_store=object_store,
                                                                 event=event,
                                                                 list_of_cadets_with_id_at_event=list_of_cadets_with_id_at_event)
...
def update_health_for_existing_cadet_at_event(
    ...
    list_of_cadets_with_id_at_event = get_list_of_cadets_with_id_and_registration_data_at_event(object_store=object_store, event=event)
    list_of_cadets_with_id_at_event.update_health_for_existing_cadet_at_event(cadet_id=cadet.id, new_health=new_health)
    update_list_of_cadets_with_id_and_registration_data_at_event(object_store=object_store,
                                                                 event=event,
                                                                 list_of_cadets_with_id_at_event=list_of_cadets_with_id_at_event)
...
def update_data_row_for_existing_cadet_at_event(
    ...
    list_of_cadets_with_id_at_event = get_list_of_cadets_with_id_and_registration_data_at_event(object_store=object_store, event=event)
    list_of_cadets_with_id_at_event.update_data_row_for_existing_cadet_at_event(cadet_id=cadet.id, new_data_in_row=new_data_in_row)
    update_list_of_cadets_with_id_and_registration_data_at_event(object_store=object_store,
                                                                 event=event,
                                                                 list_of_cadets_with_id_at_event=list_of_cadets_with_id_at_event)
