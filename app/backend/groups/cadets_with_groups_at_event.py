...
def get_list_of_all_groups_at_event(
    ...
    return object_store.get(object_store.data_api.data_list_of_cadets_with_groups.get_list_of_all_groups_at_event,
                            event_id=event.id)
...
def get_group_allocations_for_event_active_cadets_only(
    ...
    return object_store.get(object_store.data_api.data_list_of_cadets_with_groups.get_group_allocations_for_event_active_cadets_only, event_id=event.id)
