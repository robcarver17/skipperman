...
from app.logic.reporting.shared.arrangement_state import get_stored_arrangement, get_stored_arrangement_and_group_order
...
def augment_order_of_groups_with_sizes(
    ...
    return ["%s (%d)" % (group, get_group_size(group, sizes)) for group in reporting_options.group_order]
