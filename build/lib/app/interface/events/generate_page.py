...
from app.interface.events.constants import ADD_EVENT_BUTTON_LABEL, ADD_EVENT_STAGE, all_sort_types, VIEW_EVENT_STAGE, WA_UPLOAD_SUBSTAGE_IN_VIEW_EVENT_STAGE, WA_IMPORT_SUBSTAGE_IN_VIEW_EVENT_STAGE, WA_ADD_CADET_IDS_ITERATION_IN_VIEW_EVENT_STAGE, WA_UPDATE_SUBSTAGE_IN_VIEW_EVENT_STAGE
from app.interface.events.add_event import get_view_for_add_event
from app.interface.events.specific_event.view_specific_event import view_of_events_with_event_selected, post_action_on_selected_event
...
from app.interface.events.WA.process_staged_files.wa_iteratively_add_cadet_ids import post_response_when_adding_cadet_ids_to_event
