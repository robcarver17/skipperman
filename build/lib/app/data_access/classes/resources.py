...
class DataListOfCadetAtEventWithClubDinghies(object):
    ...
    def write(self, list_of_cadets_at_event_with_club_dinghies: ListOfCadetAtEventWithClubDinghies, event_id: str):
        raise NotImplemented
...
class DataListOfVolunteersAtEventWithPatrolBoats(object):
    ...
    def write(self, list_of_volunteers_at_event_with_patrol_boats: ListOfVolunteersAtEventWithPatrolBoats, event_id: str):
        raise NotImplemented
