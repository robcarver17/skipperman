...
def get_volunteer_from_list_of_given_str_of_volunteer(object_store: ObjectStore, volunteer_as_str: str) -> Volunteer:
    list_of_volunteers = get_list_of_volunteers(object_store)
...
def update_list_of_volunteers(object_store: ObjectStore, list_of_volunteers:  ListOfVolunteers):
    object_store.update(new_object=list_of_volunteers, object_definition=object_definition_for_volunteers)
