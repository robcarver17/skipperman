...
def get_master_layout(include_title: str = "'SKIPPERMAN'", include_read_only_toggle: bool = False, include_user_options: bool = True):
    ...
    html_header = get_html_header(include_read_only_toggle=include_read_only_toggle, include_title=include_title, include_user_options=include_user_options)
