...
def DEPRECATE_get_list_of_active_associated_cadet_id_in_mapped_event_data_given_identified_volunteer_and_cadet(event: Event, volunteer_id: str) -> List[str]:
    ...
    all_identified_volunteers_at_event = DEPRECATED_load_list_of_identified_volunteers_at_event(event)
...
def mark_all_cadets_associated_with_volunteer_at_event_as_no_longer_changed(event: Event, volunteer_id: str):
    list_of_associated_cadet_ids = DEPRECATE_get_list_of_associated_cadet_id_for_volunteer_at_event(event=event, volunteer_id=volunteer_id)

    for cadet_id in list_of_associated_cadet_ids:
        DEPRECATE_mark_cadet_at_event_as_unchanged(cadet_id=cadet_id, event=event)

def DEPRECATE_get_list_of_associated_cadet_id_for_volunteer_at_event(event: Event, volunteer_id: str)-> List[str]:
    volunteer_at_event = DEPRECATE_get_volunteer_at_event_with_id(event=event, volunteer_id=volunteer_id)
...
def DEPRECATE_get_dict_of_relevant_volunteer_names_and_association_cadets_with_id_values(
                                                                               cadet_id: str, event: Event) \
        -> Dict[str, str]:

    ## list of volunteers at event
    list_of_volunteers_ids = DEPRECATE_volunteer_ids_associated_with_cadet_at_specific_event(event=event, cadet_id=cadet_id)
    list_of_relevant_volunteer_names_and_other_cadets = [DEPRECATE_get_volunteer_name_and_associated_cadets_for_event(
...
def DEPRECATED_get_list_of_relevant_information(volunteer_id: str, event: Event) -> ListOfRelevantInformationForVolunteer:
    ...
    list_of_relevant_information = [DEPRECATED_get_relevant_information_for_volunteer_in_event_at_row_and_index(
