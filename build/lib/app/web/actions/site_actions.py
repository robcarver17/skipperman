...
from app.frontend.form_handler import DEPRECATE_FormHandler
...
def get_form_handler_for_specific_action(action_name) -> DEPRECATE_FormHandler:
    form_mapping = get_functions_mapping_for_action_name(action_name)

    interface = DEPRECATED_flaskInterface(
        action_name=action_name,
        display_and_post_form_function_maps=form_mapping,
        object_store=object_store,
    )

    return DEPRECATE_FormHandler(interface)
