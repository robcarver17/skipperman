...
from app.objects_OLD.cadet_at_event import  ListOfCadetsAtEvent, CadetAtEvent, CadetEventData
from app.objects_OLD.primtive_with_id.cadet_with_id_at_event import ListOfCadetsWithIDAtEvent, CadetWithIdAtEvent
