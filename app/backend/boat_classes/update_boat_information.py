from app.objects.composed.cadets_at_event_with_boat_classes_and_partners import CadetBoatClassAndPartnerAtEventOnDay, \
    ListOfCadetBoatClassAndPartnerAtEventOnDay, no_partnership_given_partner_cadet_as_str, \
...
from app.backend.boat_classes.list_of_boat_classes import get_list_of_boat_classes, get_boat_class_from_name
...
object_store: ObjectStore,
    ...
    dict_of_cadets_and_boat_classes_and_partners_at_events =get_dict_of_cadets_and_boat_classes_and_partners_at_events(
...
def convert_list_of_inputs_to_list_of_cadet_at_event_objects(
    ...
    return ListOfCadetBoatClassAndPartnerAtEventOnDay(
        [
            convert_single_input_to_cadet_with_class_and_partner_at_event(object_store=object_store,
...
def convert_single_input_to_cadet_with_class_and_partner_at_event(
    ...
    boat_class = get_boat_class_from_name(object_store=object_store, boat_class_name=update.boat_class_name)
...
def get_two_handed_partner_from_str(
    ...
    two_handed_partner = get_cadet_from_list_of_cadets_given_str_of_cadet(object_store=object_store, cadet_selected=two_handed_partner_cadet_as_str)
...
def update_boat_info_for_updated_cadets_at_event(
    ...
    for cadet_boat_class_and_partner_on_day in list_of_updated_cadets:
        if is_cadet_unavailable_on_day(object_store=object_store,
                                        event=event,
