...
def list_of_previously_used_event_names(object_store: ObjectStore) -> list:
    list_of_events = (
        get_list_of_events(object_store))
...
def add_new_verified_event(object_store: ObjectStore, event: Event):
    ...
    update_list_of_events(object_store=object_store, updated_list_of_events=list_of_events)
...
def update_list_of_events(object_store: ObjectStore, updated_list_of_events:ListOfEvents):
