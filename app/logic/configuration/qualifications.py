...
from app.backend.data.qualification import load_list_of_qualifications, save_list_of_qualifications, modify_qualification_given_string_and_return_list, add_new_qualification_given_string_and_return_list, delete_qualification_given_string_and_return_list
...
def save_from_ordinary_list_of_qualifications(list_of_qualifications: List[Qualification]):
    save_list_of_qualifications(ListOfQualifications(list_of_qualifications))
