...
from app.objects.users_and_security import default_admin_user_if_none_defined, ADMIN_GROUP, SKIPPER_GROUP
from app.web.flask.flash import flash_error, flash_log
from app.web.flask.security import get_all_flask_users, get_username, get_access_group_for_current_user
...
def welcome_message_for_user():
    ...
    if access_group==SKIPPER_GROUP:
        return "Welcome skipper %s! (well, skipper or not you have skipper access privileges)" % usernmae
