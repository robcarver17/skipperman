...
from app.data_access.store.object_definitions import object_definition_for_list_of_boat_classes
...
def update_list_of_boat_classes(object_store: ObjectStore, updated_list_of_boat_classes: ListOfBoatClasses):
    object_store.update(new_object=updated_list_of_boat_classes, object_definition=object_definition_for_list_of_boat_classes)
