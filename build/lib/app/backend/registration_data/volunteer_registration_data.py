...
def get_availability_dict_for_volunteers_at_event(    object_store: ObjectStore, event: Event
    ...
    return dict([(volunteer, registration_data.get_data_for_volunteer(volunteer).availablity) for volunteer in registration_data.list_of_volunteers_at_event()])
