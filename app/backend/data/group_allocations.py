...
class GroupAllocations():
    ...
    def get_list_of_cadets_with_group_at_event(self, include_unallocated_cadets: bool = True):
    ...
    def active_cadet_ids_at_event_with_allocations_including_unallocated_cadets(self) -> ListOfCadetIdsWithGroups:
        list_of_cadet_ids_with_groups = self.active_cadet_ids_at_event_with_allocations()
        unallocated_cadets = self.unallocated_cadet_ids_at_event()
    ...
    def active_cadet_ids_at_event_with_allocations(self) -> ListOfCadetIdsWithGroups:
        ...
        list_of_active_cadet_ids_at_event = self.list_of_active_cadet_ids_at_event()
    ...
    def unallocated_cadet_ids_at_event(self):
        list_of_cadets_in_groups_at_event = self.list_of_cadets_with_groups
        list_of_active_cadets_at_event = self.cadets_at_event_data.list_of_active_cadet_ids_at_event()

        unallocated_cadets = (
            list_of_cadets_in_groups_at_event.cadets_in_list_not_allocated_to_group(
    ...
    def list_of_active_cadet_ids_at_event(self):
        active_cadets =self.cadets_at_event_data.list_of_active_cadet_ids_at_event()
        return active_cadets.list_of_cadet_ids()
