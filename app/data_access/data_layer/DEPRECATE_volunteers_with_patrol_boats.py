...
from app.objects_OLD.primtive_with_id.patrol_boats import ListOfPatrolBoats, PatrolBoat
from app.objects_OLD.primtive_with_id.patrol_boats import ListOfVolunteersWithIdAtEventWithPatrolBoatsId
