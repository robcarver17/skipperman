...
from app.logic.reporting.shared.generic_report_pages import display_initial_generic_report_form, \
    post_form_initial_generic_report, display_form_for_generic_report_all_options, \
    ...
    post_form_for_generic_report_print_options, post_form_for_generic_report_arrangement_options, \
...
def post_form_report_group_allocation(
    ...
    return post_form_initial_generic_report(interface=interface, report_generator=allocation_report_generator)
...
def display_form_for_report_group_allocation_all_options(
    ...
    return display_form_for_generic_report_all_options(interface=interface, report_generator=allocation_report_generator)
...
def post_form_for_report_group_allocation_all_options(
    ...
    return post_form_for_generic_report_all_options(interface=interface, report_generator=allocation_report_generator)
...
def display_form_for_report_group_additional_options(
    ...
    return display_form_for_generic_report_additional_options(interface=interface, report_generator=allocation_report_generator)

def post_form_for_report_group_additional_options(
    interface: abstractInterface,
) -> Union[Form, NewForm, File]:
    return post_form_for_generic_report_additional_options(interface=interface, report_generator=allocation_report_generator)
...
def display_form_for_report_group_allocation_print_options(
    ...
    return display_form_for_generic_report_print_options(interface=interface, report_generator=allocation_report_generator)


def post_form_for_report_group_allocation_print_options(
    interface: abstractInterface,
) -> Union[Form, NewForm, File]:
    return post_form_for_generic_report_print_options(interface=interface, report_generator=allocation_report_generator)
...
def display_form_for_group_arrangement_options_allocation_report(interface: abstractInterface) -> Form:
    return display_form_for_generic_report_arrangement_options(interface=interface, report_generator=allocation_report_generator)


def post_form_for_group_arrangement_options_allocation_report(
        interface: abstractInterface,
) -> Union[NewForm, Form, File]:
    return post_form_for_generic_report_arrangement_options(interface=interface, report_generator=allocation_report_generator)
