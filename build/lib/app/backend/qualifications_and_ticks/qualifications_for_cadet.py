...
def apply_qualification_to_cadet(
    ...
    dict_of_qualifications_for_all_cadets.apply_qualification_to_cadet(cadet=cadet, qualification=qualification)
    update_dict_of_qualifications_for_all_cadets(object_store=object_store, dict_of_qualifications=dict_of_qualifications_for_all_cadets)

def remove_qualification_from_cadet(
    object_store: ObjectStore, cadet: Cadet, qualification: Qualification
):
    dict_of_qualifications_for_all_cadets = get_dict_of_qualifications_for_all_cadets(object_store)
    dict_of_qualifications_for_all_cadets.remove_qualification_from_cadet(cadet=cadet, qualification=qualification)
    update_dict_of_qualifications_for_all_cadets(object_store=object_store, dict_of_qualifications=dict_of_qualifications_for_all_cadets)
...
def update_dict_of_qualifications_for_all_cadets(object_store: ObjectStore, dict_of_qualifications: DictOfQualificationsForCadets):
    object_store.update(object_definition=object_definition_for_dict_of_qualifications_for_cadets, new_object=dict_of_qualifications)