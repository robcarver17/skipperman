...
from app.backend.administration.delete_cadets import delete_cadet_in_data_and_return_warnings
...
def display_deleting_cadet_process(interface: abstractInterface):
    ...
    warnings = delete_cadet_in_data_but_do_not_save_cache_and_return_warnings(interface,
    ...
    return Form(
        ListOfLines(
        [
           Heading("Deleting %s" % (cadet_to_delete)),
            _______________
        ]+warnings+[
...
def delete_cadet_in_data_but_do_not_save_cache_and_return_warnings(interface: abstractInterface,
                                                          cadet_to_delete: Cadet) -> ListOfLines:

    warnings = delete_cadet_in_data_and_return_warnings(interface.object_store, cadet_to_delete=cadet_to_delete)
