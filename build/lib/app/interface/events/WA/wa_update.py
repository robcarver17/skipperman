from app.interface.events.WA.utils import get_form_for_wa_upload, verify_and_save_uploaded_wa_event_file, \
    reset_stage_and_return_previous, upload_wa_file_and_save_as_raw_event_with_mapping, delete_staged_file_for_current_event
...
def respond_to_uploaded_file_for_wa_update(state_data: StateDataForAction):
    try:
        ...
        return reset_stage_and_return_previous(state_data=state_data, error_msg='Problem with file upload and import %s, try again' % e)
