...
from app.logic.events.constants import (
    ...
    EVENT_END_DATE,
    EVENT_TYPE,
CHECK_BUTTON_LABEL, FINAL_ADD_BUTTON_LABEL
)
...
def post_form_view_for_add_event(interface: abstractInterface, first_time_displayed: bool=False) -> Union[Form, NewForm]:
...
event_and_text_if_first_time = EventAndVerificationText(event=default_event, verification_text="")

def get_add_event_form(interface: abstractInterface,
...
def process_form_when_checking_event(
    ...
    try:
        ...
        verify_text = \
            "Doesn't appear to be a valid event (wrong date time in old browser?) error code %s"% str(e)
