...
def get_stored_arrangement_and_group_order(interface: abstractInterface, report_type: str) -> ArrangementOptionsAndGroupOrder:
    ...
    arrangement_options_and_group_order = options_data.get_arrange_group_options(report_name=report_type)
...
def reset_arrangement_report_options(interface: abstractInterface, report_generator: ReportGenerator):
    options_data = OptionsData(interface.data)
