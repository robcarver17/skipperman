...
from app.backend.events.cadets_at_event import get_attendance_matrix_for_list_of_cadets_at_event
...
def summarise_class_attendance_for_event(
    ...
    dict_of_cadets_and_boat_classes_and_partners_at_events = get_dict_of_cadets_and_boat_classes_and_partners_at_events(object_store=object_store,
                                                                                                                        event=event)
    list_of_boat_classes = (
        dict_of_cadets_and_boat_classes_and_partners_at_events.unique_sorted_list_of_boat_classes_at_event()
    )
    row_names = list_of_boat_classes.list_of_names()
    ...
    for day in event.weekdays_in_event():
        result_dict[day] = [
            ...
            if dict_of_cadets_and_boat_classes_and_partners_at_events.boat_classes_and_partner_for_cadet(
                cadet
            ).is_in_boat_class_on_day(day=day, boat_class=boat_class)
