...
class ListOfVolunteersAtEventWithSkillsAndRolesAndPatrolBoatsOnSpecificday(List[VolunteerAtEventWithSkillsAndRolesAndPatrolBoatsOnSpecificday]):
    def has_volunteer_role_on_day(self, role: RoleWithSkills):
        return ListOfVolunteersAtEventWithSkillsAndRolesAndPatrolBoatsOnSpecificday(
            [
                volunteer_at_event for volunteer_at_event in self if volunteer_at_event.has_volunteer_role(
                role=role)
...
class VolunteerAtEventWithSkillsAndRolesAndPatrolBoats:
    ...
    def assigned_to_boat_on_day(self, patrol_boat: PatrolBoat, day: Day)-> bool:
        return self.patrol_boat_by_day.assigned_to_boat_on_day(patrol_boat=patrol_boat, day=day)
    ...
    def for_specific_day(self, day: Day) -> VolunteerAtEventWithSkillsAndRolesAndPatrolBoatsOnSpecificday:
        return VolunteerAtEventWithSkillsAndRolesAndPatrolBoatsOnSpecificday(
            volunteer=self.volunteer,
            skills=self.skills,
            event=self.event,
            role_and_group=self.role_and_group_by_day.role_and_group_and_team_on_day(day),
...
class ListOfVolunteersAtEventWithSkillsAndRolesAndPatrolBoats(List[VolunteerAtEventWithSkillsAndRolesAndPatrolBoats]):
    def assigned_to_boat_on_day(self, patrol_boat: PatrolBoat, day: Day) -> ListOfVolunteersAtEventWithSkillsAndRolesAndPatrolBoatsOnSpecificday:
        return ListOfVolunteersAtEventWithSkillsAndRolesAndPatrolBoatsOnSpecificday(
            [
            volunteer_at_event.for_specific_day(day) for volunteer_at_event in self if volunteer_at_event.assigned_to_boat_on_day(
    ...
    def assigned_to_any_boat_on_day(self,  day: Day) -> ListOfVolunteersAtEventWithSkillsAndRolesAndPatrolBoatsOnSpecificday:
        return ListOfVolunteersAtEventWithSkillsAndRolesAndPatrolBoatsOnSpecificday(
            [
            volunteer_at_event.for_specific_day(day) for volunteer_at_event in self if volunteer_at_event.assigned_to_any_boat_on_day(day)
                ]
        )
