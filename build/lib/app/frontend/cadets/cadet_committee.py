...
from app.backend.cadets.cadet_committee import get_list_of_cadets_on_committee, \
    get_list_of_cadets_who_are_members_but_not_on_committee_ordered_by_name, get_next_year_for_cadet_committee_after_EGM, \
...
def select_or_deselect_button(cadet_on_committee: CadetOnCommittee) -> Union[Button, str]:
...
def dropdown_list_of_cadets_not_on_committee(interface: abstractInterface):
    list_of_cadets_not_on_committee_ordered_by_age = (
        get_list_of_cadets_who_are_members_but_not_on_committee_ordered_by_name(object_store=interface.object_store)
    )
...
def select_or_deselect_cadet_from_committee(
    ...
    toggle_selection_for_cadet_committee_member(object_store=interface.object_store, cadet=cadet)
