...
ALL_FIELDS_EXPECTED_IN_WA_FILE_MAPPING = [eval(field) for field in all_fields if not field[0]=="_"]
...
FIELDS_AS_STR = [RESPONSIBLE_ADULT_NUMBER] ## Only fields where resolving as natural field would cause problems eg phone numbers
...
GROUP_ALLOCATION_FIELDS_HIDE = [CADET_BOAT_SAIL_NUMBER]