...
from app.objects.partners import NO_PARTNER_REQUIRED_STR, NOT_ALLOCATED_STR
...
no_cadet_partner_required = NoCadetPartner[NO_PARTNER_REQUIRED_STR]
no_partner_allocated = NoCadetPartner[NOT_ALLOCATED_STR]



def are_partners_equal(partner: Union[Cadet, NoCadetPartner], other_partner: Union[Cadet, NoCadetPartner])->bool:
...
class ListOfCadetBoatClassAndPartnerAtEventOnDay(
    ...
    def list_of_valid_partners(self) -> ListOfCadets:
        ...
        print("Gen Z voice: valid")
        print(list_of_all_partners)
