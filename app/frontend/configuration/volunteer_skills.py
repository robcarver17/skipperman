...
from app.backend.volunteers.skills import get_list_of_skills, update_list_of_skills, add_new_volunteer_skill, modify_volunteer_skill
from app.frontend.configuration.generic_list_modifier import BACK_BUTTON_PRESSED, BUTTON_NOT_KNOWN, save_button, \
    up_button_for_entry, down_button_for_entry, ADD_ENTRY_TEXT_FIELD, add_button, text_box_name, \
    get_list_of_arrow_buttons, reorder_list_given_form, display_form_edit_generic_list, post_form_edit_generic_list
...
def save_from_ordinary_list_of_skills(
        object_store: ObjectStore, new_list: List[Skill]
):
    update_list_of_skills(
        object_store=object_store,
        list_of_skills=ListOfSkills(new_list))
