...
from app.objects.ticks import TickSubStage, ListOfTickSheetItems, ListOfTickSubStages, TickSheetItem
...
class QualificationsAndTickItemsAsDict(Dict[Qualification, TickSubStagesAsDict]):
    def __init__(self, list_of_qualifications: ListOfQualifications,
                                                                 list_of_tick_sheet_items: ListOfTickSheetItems,
                                                                 list_of_tick_sub_stages: ListOfTickSubStages):
        dict_of_items = create_raw_qualifications_and_tick_items_as_dict_from_underyling(
...
def create_qualifications_and_tick_items_as_dict_from_underyling(list_of_qualifications: ListOfQualifications,
                                                                 list_of_tick_sheet_items: ListOfTickSheetItems,
                                                                 list_of_tick_sub_stages: ListOfTickSubStages,
                                                                 ) -> QualificationsAndTickItemsAsDict:
    return QualificationsAndTickItemsAsDict(list_of_qualifications=list_of_qualifications,
                                            list_of_tick_sheet_items=list_of_tick_sheet_items,
                                            list_of_tick_sub_stages=list_of_tick_sub_stages)

def create_raw_qualifications_and_tick_items_as_dict_from_underyling(list_of_qualifications: ListOfQualifications,
                                                                 list_of_tick_sheet_items: ListOfTickSheetItems,
                                                                 list_of_tick_sub_stages: ListOfTickSubStages,
...
def list_of_substages_given_list_of_tick_sheet_items(
    ...
    return list_of_substages_given_list_of_ids(list_of_substage_ids=list_of_substage_ids, list_of_tick_sub_stages=list_of_tick_sub_stages)

def list_of_substages_given_list_of_ids(
    list_of_tick_sub_stages: ListOfTickSubStages,
     list_of_substage_ids: List[str]
) -> ListOfTickSubStages:
