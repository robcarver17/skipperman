...
- If the first day of the event is a registration day, which will have no volunteer or patrol boat rota. This normally only applies to Cadet week.
...
Click on `Check details entered` when you have input the required information. At this stage you may be presented with the start and end date so you can check these, and potentially a series of warnings.
...
- The name of the event has to be more than 3 characters long
- There is a registration day, and the event is only one day long.
