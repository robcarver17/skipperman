...
- Save and back - save any changes made in text boxes or dropdowns, and go back to the previous page.
- Back - return to the previous page. Only available on pages when no editing can be done.

Especially don't use the browser back button  in the middle of an import as it will cause unusual behaviour and may result in data corruption. If you use the back button at other times your changes won't be saved.

Also, **avoid using the 'refresh' button on your browser to update the data** Instead press cancel or back.
...
Once you have selected a Skipperman option you will usually see this menu bar with the options in capitals:

***
***
![submenubar.png](../static/submenubar.png)
***
***

This will exclude the current menu option that you are inside (here it's Events that is missing). Choosing any of these buttons will open up a new window. Note the two windows won't be aware of any changes made in the other window, until you save on one, and go back on the other.