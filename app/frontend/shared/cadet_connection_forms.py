...
def get_selected_cadet_from_form(interface: abstractInterface) -> Cadet:
    selected_cadet_id = get_cadet_id_to_add_from_dropdown(
        interface, default=MISSING_FROM_FORM
    )
...
def get_cadet_id_to_add_from_dropdown(
    interface: abstractInterface, default=MISSING_FROM_FORM
):
