...
from app.objects.partners import (valid_partnership_given_partner_id_or_str,
...
def existing_partnership(interface: abstractInterface,
                                  event: Event,
                                  cadet_boat_class_group_club_dinghy_and_partner_on_day: CadetBoatClassClubDinghyGroupAndPartnerAtEventOnDay):
...
def breakup_partnership(interface: abstractInterface, event: Event, cadet: Cadet, list_of_days: List[Day]):
...
def write_changes_to_single_cadet(interface: abstractInterface,
                                  event: Event,
                                  cadet_boat_class_group_club_dinghy_and_partner_on_day: CadetBoatClassClubDinghyGroupAndPartnerAtEventOnDay):
