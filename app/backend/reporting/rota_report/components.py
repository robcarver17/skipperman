...
volunteer_with_role_and_group_and_team: VolunteerWithRoleGroupAndTeamAtEvent
    ...
    role_str = get_role_string(
        volunteer_with_role_and_group_and_team
    )
...
def get_role_string(
        volunteer_with_role_and_group_and_team: VolunteerWithRoleGroupAndTeamAtEvent) -> str:
...
def get_boat_string(
    ...
    all_volunteers_and_boats = volunteer_event_data.dict_of_volunteers_at_event_with_patrol_boats
