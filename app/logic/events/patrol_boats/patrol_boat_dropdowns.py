...
from app.backend.data.dinghies import (
...
def get_allocation_dropdown_elements_to_add_volunteer_for_day_and_boat(
    ...
    dropdown_elements = [
        from_volunteer_id_to_dropdown_element(
...
def from_volunteer_id_to_dropdown_element(
...
def from_selected_dropdown_to_volunteer(
    ...
    return get_volunteer_from_list_of_volunteers_given_volunteer_name(
