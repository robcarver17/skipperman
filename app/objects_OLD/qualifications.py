...
from app.objects_OLD.cadets import ListOfCadets

from app.objects_OLD.utils import in_x_not_in_y

from app.objects_OLD.exceptions import missing_data, arg_not_passed
...
class ListOfCadetsWithQualifications(GenericListOfObjectsWithIds):
    ...
    def sort_by_date(self):
        return ListOfCadetsWithQualifications(
