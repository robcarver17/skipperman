...
from app.data_access.store.object_definitions import object_definition_for_list_of_club_dinghies
...
def add_new_club_dinghy_given_string(
    ...
    update_list_of_boat_classes(object_store=object_store, updated_list_of_boat_classes=list_of_boats)
...
def modify_club_dinghy(
    ...
    list_of_boats = get_list_of_boat_classes(object_store)
    list_of_boats.replace(existing_club_dinghy = existing_object, new_club_dinghy = new_object)
    try:
...
def update_list_of_boat_classes(object_store: ObjectStore, updated_list_of_boat_classes: ListOfClubDinghies):
    object_store.update(new_object=updated_list_of_boat_classes, object_definition=object_definition_for_list_of_club_dinghies)
