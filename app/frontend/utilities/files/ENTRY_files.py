...
from app.frontend.utilities.files.render_files import (
    ...
    uploads_file_hedaer,
    CLEAR_TEMP_BUTTON_LABEL,
    CLEAR_STAGING_BUTTON_LABEL,
    CLEAR_PUBLIC_BUTTON_LABEL,
    UPLOAD_PUBLIC_FILE,
    DELETE_SELECTED_FILES,
    get_list_of_all_qr_buttons,
    get_list_of_all_delete_buttons,
    get_list_of_all_replace_buttons,
...
from app.objects_OLD.abstract_objects.abstract_tables import DetailTable
