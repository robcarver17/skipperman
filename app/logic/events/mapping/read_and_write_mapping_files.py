...
from app.data_access.csv.wa_field_mapping import read_mapping_from_file_object_or_filename, save_mapping_to_filename
...
def write_template(template_name, new_mapping):
    data.data_wa_field_mapping.write_template(template_name=template_name, wa_field_mapping=new_mapping)
