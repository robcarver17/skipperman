...
def create_column_report_from_df_and_return_filename(reporting_options: ReportingOptions
                                                     ) -> str:
    ...
    list_of_pages_with_columns = create_list_of_pages_with_columns_from_list_of_pages(list_of_pages=list_of_pages,
