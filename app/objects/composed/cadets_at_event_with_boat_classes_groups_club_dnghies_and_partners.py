...
from app.objects.partners import no_cadet_partner_required, \
    ...
    valid_partnership_given_partner_cadet, NoCadetPartner, no_partnership_given_partner_cadet
...
class CadetBoatClassClubDinghyGroupAndPartnerAtEventOnDay:
    ...
    def __eq__(self, other):
        ...
        return self.cadet ==other.cadet and \
                ...
                self.club_dinghy == other.club_dinghy and \
...
class ListOfCadetBoatClassClubDinghyGroupAndPartnerAtEventOnDay(List[CadetBoatClassClubDinghyGroupAndPartnerAtEventOnDay]):
