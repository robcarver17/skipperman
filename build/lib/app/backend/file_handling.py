...
def create_local_file_from_uploaded_and_return_filename(
    ...
    original_file = verify_and_return_uploaded_wa_event_file(interface=interface, file_marker_name=file_marker_name)
    original_filename = save_uploaded_file_as_local_temp_file(original_file)

    return original_filename


def verify_and_return_uploaded_wa_event_file(interface: abstractInterface, file_marker_name: str):
