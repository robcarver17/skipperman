...
from app.frontend.utilities.data_and_backups.restore_backup_from_local import display_form_for_upload_backup
from app.frontend.utilities.data_and_backups.restore_backup_from_snapshot import display_form_view_of_snapshots
...
def make_backup_given_data(interface: abstractInterface):
    make_backup(backup_data_path=interface.data.data.backup_data_path, master_data_path=interface.data.data.master_data_path)
