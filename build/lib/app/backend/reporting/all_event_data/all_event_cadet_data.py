...
def get_df_for_cadets_event_data_dump(
    ...
    list_of_club_dinghy = [club_dinghy_for_cadet(interface=interface, event=event, cadet_id=cadet_id)
                           for cadet_id in list_of_cadet_ids]
    list_of_boat_class=  [boat_class_for_cadet(interface=interface, event=event, cadet_id=cadet_id)
                           for cadet_id in list_of_cadet_ids]
    list_of_sail_number = [sail_number_for_cadet(interface=interface, event=event, cadet_id=cadet_id)
                           for cadet_id in list_of_cadet_ids]
    list_of_partner_names = [partner_name_for_cadet(interface=interface, event=event, cadet_id=cadet_id)
                           for cadet_id in list_of_cadet_ids]
    list_of_volunteer_names = [names_of_volunteers_for_cadet(interface=interface, event=event, cadet_id=cadet_id)
                           for cadet_id in list_of_cadet_ids]
...
def club_dinghy_for_cadet(interface: abstractInterface, event: Event, cadet_id: str):
    ...
    day_item_dict= dict([(day, dinghy_data.name_of_club_dinghy_for_cadet_at_event_on_day_or_default(event=event, cadet_id=cadet_id, day=day,default='')) for day in event.weekdays_in_event()])
...
def boat_class_for_cadet(interface: abstractInterface, event: Event, cadet_id: str):
    dinghy_data =DinghiesData(interface.data)
    day_item_dict= dict([(day, dinghy_data.name_of_boat_class_for_cadet_at_event_on_day_or_default(event=event, cadet_id=cadet_id, day=day, default='')) for day in event.weekdays_in_event()])
...
def sail_number_for_cadet(interface: abstractInterface, event: Event, cadet_id: str):
    dinghy_data =DinghiesData(interface.data)
    day_item_dict= dict([(day, dinghy_data.sail_number_for_cadet_at_event_on_day_or_default(event=event, cadet_id=cadet_id, day=day, default='')) for day in event.weekdays_in_event()])
...
def partner_name_for_cadet(interface: abstractInterface, event: Event, cadet_id: str):
    dinghy_data =DinghiesData(interface.data)
    day_item_dict= dict([(day, dinghy_data.partner_name_for_cadet_at_event_on_day_or_default(event=event, cadet_id=cadet_id, day=day, default='')) for day in event.weekdays_in_event()])
