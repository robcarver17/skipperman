...
def post_form_report_boat(
    ...
    return post_form_initial_generic_report(interface=interface, report_generator=boat_report_generator)
...
def display_form_for_boat_report_all_options(
    ...
    return display_form_for_generic_report_all_options(interface=interface, report_generator=boat_report_generator)

def post_form_for_boat_report_all_options(
    interface: abstractInterface,
) -> Union[Form, NewForm, File]:
    return post_form_for_generic_report_all_options(interface=interface, report_generator=boat_report_generator)

# REPORT_ADDITIONAL_OPTIONS_FOR_boat_REPORT_STATE
def display_form_for_boat_report_additional_options(
    interface: abstractInterface,
) -> Union[Form, NewForm]:
    return display_form_for_generic_report_additional_options(interface=interface, report_generator=boat_report_generator)
...
def post_form_for_boat_report_additional_options(
    ...
    return post_form_for_generic_report_additional_options(interface=interface, report_generator=boat_report_generator)
...
def display_form_for_boat_report_print_options(
    ...
    return display_form_for_generic_report_print_options(interface=interface, report_generator=boat_report_generator)
...
def post_form_for_boat_report_print_options(
    ...
    return post_form_for_generic_report_print_options(interface=interface, report_generator=boat_report_generator)


#CHANGE_GROUP_LAYOUT_IN_boat_REPORT_STATE
def display_form_for_group_arrangement_options_boat_report(interface: abstractInterface) -> Form:
    return display_form_for_generic_report_arrangement_options(interface=interface, report_generator=boat_report_generator)
...
def post_form_for_group_arrangement_options_boat_report(
    ...
    return post_form_for_generic_report_arrangement_options(interface=interface, report_generator=boat_report_generator)
