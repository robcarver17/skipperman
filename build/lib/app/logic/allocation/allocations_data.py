...
from app.logic.cadets.view_cadets import (
    get_list_of_cadets,
    cadet_from_id_with_passed_list,
)
...
def get_list_of_cadets_in_mapped_wa_event(
    ...
    list_of_ids = get_list_of_cadet_ids_in_mapped_wa_event(
        event=event,
        exclude_active=exclude_active,
        exclude_deleted=exclude_deleted,
        exclude_cancelled=exclude_cancelled,
    ...
    cadets_in_event = [
        cadet_from_id_with_passed_list(cadet_id=cadet_id, list_of_cadets=list_of_cadets)
...
def get_unallocated_cadets(
    ...
    if list_of_cadet_ids_with_groups is arg_not_passed:
        list_of_cadet_ids_with_groups = get_current_allocations(event=event)
