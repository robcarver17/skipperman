...
from app.objects.composed.cadets_at_event_with_boat_classes_groups_club_dnghies_and_partners import \
    CadetBoatClassClubDinghyGroupAndPartnerAtEventOnDay, are_partners_equal
...
class PartnershipChange:
    ...
    def new_partner_had_partner(self):
        if self.new_partner_who_was_their_partner is None:
            return False
        return valid_partnership_given_partner_cadet(self.new_partner_who_was_their_partner)
...
def update_boat_info_for_updated_cadet_at_event(
    ...
    print("BEfore:")
    print(required_dict_for_allocation.dict_of_cadets_and_boat_class_and_partners.list_of_cadets_at_event_with_boat_class_and_partners_with_ids.as_df_of_str())

    if availability_is_bad_for_sailor_or_partner(required_dict_for_allocation=required_dict_for_allocation, cadet_boat_class_group_club_dinghy_and_partner_on_day=cadet_boat_class_group_club_dinghy_and_partner_on_day):
        print("Availablity is bad - not updating %s" % cadet_boat_class_group_club_dinghy_and_partner_on_day)
        return
...
def availability_is_bad_for_sailor_or_partner(required_dict_for_allocation: RequiredDictForAllocation, cadet_boat_class_group_club_dinghy_and_partner_on_day: CadetBoatClassClubDinghyGroupAndPartnerAtEventOnDay) -> bool:
    ...
    if valid_partnership_given_partner_cadet(partner_cadet):
        partner_availabilty = required_dict_for_allocation.availability_dict[partner_cadet]
...
def update_partnership_info_for_updated_cadet_at_event(
    ...
    print("%s: %s" % (str(cadet_boat_class_group_club_dinghy_and_partner_on_day), str(how_changed)))
...
def modify_no_partnership_status_for_existing_cadet(        required_dict_for_allocation: RequiredDictForAllocation,
    ...
    required_dict_for_allocation.dict_of_cadets_and_boat_class_and_partners.allocate_partner_for_cadet_on_day(cadet=cadet,
                                                                                               day=day,
                                                                                               cadet_partner=new_partner_status)



def break_up_existing_partnership(          required_dict_for_allocation: RequiredDictForAllocation,
                                            how_changed: PartnershipChange):
...
def create_partnership(      required_dict_for_allocation: RequiredDictForAllocation,
        how_changed: PartnershipChange,
        cadet_boat_class_group_club_dinghy_and_partner_on_day: CadetBoatClassClubDinghyGroupAndPartnerAtEventOnDay):

    if_new_partner_had_partner_remove_them(required_dict_for_allocation=required_dict_for_allocation,
                                           how_changed=how_changed
                                           )

    if_cadet_had_existing_partner_remove_them(required_dict_for_allocation=required_dict_for_allocation,
                                           how_changed=how_changed
                                              )
...
def if_new_partner_had_partner_remove_them(  required_dict_for_allocation: RequiredDictForAllocation,
        how_changed: PartnershipChange):
    ...
    if did_new_partner_have_partner:
        ...
        required_dict_for_allocation.dict_of_cadets_and_boat_class_and_partners.breakup_partnership(
            cadet=new_partner,
            partner_cadet=new_partner_original_partner,
            day=day
        )


def if_cadet_had_existing_partner_remove_them(required_dict_for_allocation: RequiredDictForAllocation,
                                           how_changed: PartnershipChange):
    ...
    if did_cadet_have_existing_partner:
        ...
        required_dict_for_allocation.dict_of_cadets_and_boat_class_and_partners.breakup_partnership(
            cadet=cadet,
            partner_cadet=original_partner,
            day=day
        )


def create_fresh_two_handed_partnership(      required_dict_for_allocation: RequiredDictForAllocation,
        cadet_boat_class_group_club_dinghy_and_partner_on_day: CadetBoatClassClubDinghyGroupAndPartnerAtEventOnDay):
    ...
    rd.dict_of_cadets_and_boat_class_and_partners.create_fresh_two_handed_partnership(cadet=cadet, partner_cadet=partner_cadet, day=day)
...
def clone_cadet_group_club_dinghy_boat_class_sail_number_to_partner(     required_dict_for_allocation: RequiredDictForAllocation,
        cadet_boat_class_group_club_dinghy_and_partner_on_day: CadetBoatClassClubDinghyGroupAndPartnerAtEventOnDay):

    cadet_boat_class_group_club_dinghy_and_partner_on_day_with_partner_as_cadet = cadet_boat_class_group_club_dinghy_and_partner_on_day.switch_partner()
    update_cadets_own_info_excluding_partner(
        required_dict_for_allocation=required_dict_for_allocation,
...
def update_cadets_own_info_excluding_partner(   required_dict_for_allocation: RequiredDictForAllocation,
        cadet_boat_class_group_club_dinghy_and_partner_on_day: CadetBoatClassClubDinghyGroupAndPartnerAtEventOnDay):
    ...
    rd = required_dict_for_allocation
    rd.dict_of_cadets_with_days_and_groups.add_or_upate_group_for_cadet_on_day(cadet=cadet,
                                                                            day=day,
                                                                            group=group)
...
def how_has_partnership_changed(
    ...
    original_cadet_with_partner = dict_of_cadets_and_boat_class_and_partners.boat_classes_and_partner_for_cadet(cadet).boat_class_and_partner_on_day(day)
    ...
    if now_valid:
        new_partner_with_partner = dict_of_cadets_and_boat_class_and_partners.boat_classes_and_partner_for_cadet(new_partner).boat_class_and_partner_on_day(day)
