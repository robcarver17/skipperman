...
def get_existing_complete_notes(interface: abstractInterface, list_of_notes: ListOfNotesWithVolunteers) -> Table:
    ...
    list_of_rows = [row_for_existing_note(existing_note_with_volunteer=existing_note_with_volunteer,
                                          interface=interface, allow_edit=False) for existing_note_with_volunteer in list_of_notes]
...
def row_for_existing_note(interface: abstractInterface, existing_note_with_volunteer: NoteWithVolunteer, allow_edit: bool = True) -> RowInTable:
    ...
    text = note_text_box(existing_note_with_volunteer) if allow_edit else existing_note_with_volunteer.text
    assigned = assigned_volunteer_dropdown(existing_note_with_volunteer=existing_note_with_volunteer, interface=interface) if allow_edit else existing_note_with_volunteer.assigned_volunteer.name
    priority = priority_dropdown(existing_note_with_volunteer) if allow_edit else existing_note_with_volunteer.priority
    ...
    return RowInTable([
        ...
        assigned,
        priority,
        completed_checkbox(existing_note_with_volunteer) ## always allow that
        ])
...
def completed_checkbox(existing_note_with_volunteer: NoteWithVolunteer):
