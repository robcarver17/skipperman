...
from app.web.flask.session_data_for_action import (
    DEPRECATE_SessionDataForAction,
...
@dataclass
class DEPRECATED_flaskInterface(abstractInterface):
    ...
    def session_data(
        self,
    ) -> DEPRECATE_SessionDataForAction:  ## pipe through to current session object
        session_data = DEPRECATE_SessionDataForAction(self.action_name)
        return session_data
