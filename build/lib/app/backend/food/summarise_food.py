...
def summarise_food_data_by_day_for_cadets(
    ...
    for age_window in age_brackets:
        ...
        summary_dict["Total over event"] = count_cadets_with_right_age(
...
def cadet_has_right_age_and_is_available_on_day(
    ...
    right_age = cadet_has_right_age(cadet=cadet, age_window=age_window)
...
def cadet_has_right_age(cadet: Cadet, age_window: List[int]) -> bool:
