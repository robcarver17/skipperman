...
def get_sorted_volunteers_allocated_to_patrol_boat_at_event_on_days_sorted_by_role(
    ...
    sorted_list_of_volunteers_on_boats = (
        sort_list_of_volunteers_for_day_and_event_by_role(
...
def get_list_of_volunteers_at_event_with_skills_and_roles_and_patrol_boats(
    ...
    list_of_volunteers = (
        all_event_data.dict_of_volunteers_at_event_with_patrol_boats.list_of_volunteers_allocated_to_patrol_boat_at_event_on_any_day()
    )
    ...
    return ListOfVolunteersAtEventWithSkillsAndRolesAndPatrolBoats(
        [
            VolunteerAtEventWithSkillsAndRolesAndPatrolBoats(
                event=event,
                volunteer=volunteer,
                skills=all_event_data.dict_of_volunteers_with_skills.dict_of_skills_for_volunteer(
                    volunteer
                ),
