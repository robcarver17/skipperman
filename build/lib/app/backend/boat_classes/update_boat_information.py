...
def update_boat_info_for_updated_cadets_at_event(
    ...
    required_dict_for_allocation = RequiredDictForAllocation(
        dict_of_cadets_and_boat_class_and_partners=get_dict_of_cadets_and_boat_classes_and_partners_at_events(
...
def propagate_changes_to_list_of_cadets_in_underlying_data(
    ...
    [
        propagate_changes_to_cadet_in_underlying_data(
            interface=interface,
            event=event,
            day=day,
            required_dict_for_allocation=required_dict_for_allocation,
...
def propagate_changes_to_cadet_in_underlying_data(
    interface: abstractInterface,
    event: Event,
    day: Day,
    cadet: Cadet,
    ...
    propagate_changes_to_boat_class_and_partners_for_cadet_in_underlying_data(
        interface=interface,
        event=event,
        day=day,
        cadet=cadet,
...
def propagate_changes_to_club_dinghies_for_cadet_in_underlying_data(
    ...
    club_dinghy = dict_of_cadets_and_club_dinghies_at_event.club_dinghys_for_person(
        cadet
    ).dinghy_on_day(day)
    interface.update(
...
def propagate_changes_to_boat_class_and_partners_for_cadet_in_underlying_data(
    interface: abstractInterface,
    event: Event,
    day: Day,
    cadet: Cadet,
...
def propagate_changes_to_days_and_groups_for_cadet_in_underlying_data(
    ...
    group = dict_of_cadets_with_days_and_groups.days_and_groups_for_cadet(
        cadet
    ).group_on_day(day)
